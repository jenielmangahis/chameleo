...
{   
        ...
        {       
                ...
                if(counter!=1)
                {
                        ...
                        document.getElementById("linkedit").href=baseUrl+"players/addresponder/edit/"+id; 
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrl+"players/changestatus/"+id+"/EmailTemplate/1/responders/cngstatus";
                                                        }else{
                                                        window.location=baseUrl+"players/changestatus/"+id+"/EmailTemplate/0/responders/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrl+"players/changestatus/"+id+"/EmailTemplate/0/responders/delete";
                                        }
                        }else{
...
<div align="center" class="slider" id="toppanel">
 ...
 <?php echo $form->create("players", array("action" => "respondors",'type' => 'file','enctype'=>'multipart/form-data','name' => 'respondors', 'id' => "respondors"))?>
...
<div class="topTabs">
				<ul class="dropdown">
					<li><?php
							e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'players','action'=>'addresponder','add'),
								array('escape' => false)
								)
							);
						?></li>
           ...
           <?php    $this->loginarea="players";    $this->subtabsel="responders";
                ...
                <td align="left" valign="middle" class='newtblbrd'>
					...
					<?php
						e($html->link(
							...
							array('controller'=>'players','action'=>'addresponder','edit',$recid),
							array('escape' => false)
							)
						);
						?>
