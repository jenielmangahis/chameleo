...
{   
 ...
 function editcontent()
        ...
        if(counter!=1)
        {
                ...
                document.getElementById("linkedit").href=baseUrl+"players/taskhistory/"+id;                 
            }
       } 
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrl+"players/changestatus/"+id+"/CommunicationTaskHistory/1/taskhistory/cngstatus";
                                                        }else{
                                                        window.location=baseUrl+"players/changestatus/"+id+"/CommunicationTaskHistory/0/taskhistory/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrl+"players/changestatus/"+id+"/CommunicationTaskHistory/0/taskhistory/delete";
                                        }
                        }else{
