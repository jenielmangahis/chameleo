...
$backUrl = $base_url.'contacts/projectcompanytypes';
 ?>
<div class="titlCont1"><div class="centerPage">
<?php echo $form->create("contacts", array("action" => "projectcompanytypes_add",'name' => 'projectcompanytypes_add', 'id' => "projectcompanytypes_add",'onsubmit' => 'return validatecompanytype("add");'));
