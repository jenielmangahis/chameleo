<script type="text/javascript">
    ...
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrl+"contacts/projectcompanytypes_add/"+id; 
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){	
                if(act=="active"){
                    window.location=baseUrl+"contacts/changestatus/"+id+"/CompanyType/1/projectcompanytypes/cngstatus";
                }else{
                    window.location=baseUrl+"contacts/changestatus/"+id+"/CompanyType/0/projectcompanytypes/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrl+"contacts/changestatus/"+id+"/CompanyType/0/projectcompanytypes/delete";
            }
        }else{
...
<div class="container">
       <div class="titlCont"><div class="centerPage">
            ...
            <?php echo $form->create("contacts", array("action" => "projectcompanytypes",'name' => 'projectcompanytypes', 'id' => "projectcompanytypes")) ?>
            <script type='text/javascript'>
            ...
            <div class="topTabs">
                <ul class="dropdown">
						...
						<?php
							e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'contacts','action'=>'projectcompanytypes_add'),
								array('escape' => false)
								)
							);
						?>
            ...
            <?php    $this->loginarea="contacts";    $this->subtabsel="projectcompanytypes";
...
<div class="midCont" id="newhldtab">
    ...
    <div>
      ...
      ?> 
            ...
            <span class="srchBg2">
                <input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'contacts/projectcompanytypes')" id="locaa">&nbsp;&nbsp;  
           </span>
    ...
    <div class="tblData">
        ...
        <th align="center" valign="middle" style="width:2%"><input type="checkbox" id="checkall" name="checkall" value=""></th>
            <th align="center" valign="middle" style="width:70%"><span class="right"><?php echo $pagination->sortBy('company_type_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Company Type</th>
       ...
       <tr class='altrow'><td align="center" class='newtblbrd' valign="middle"><?php echo $i++ ?></td><td align="center" class='newtblbrd'    
        ...
        <td align="left" class='newtblbrd' valign="middle">
			...
			<?php
					...
					array('controller'=>'contacts','action'=>'projectcompanytypes_add',$recid),
					array('escape' => false)
					)
				);
			?>
