...
<script type="text/javascript">
    ...
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrl+"prospects/addprospectnonprofit/"+id+"/Nonprofit"; 
        ...
        if(id !=""){
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrl+"players/changestatus/"+id+"/Company/0/projectmerchantlist/delete";
            }
        }else{
...
<div class="container">
         <div class="titlCont">
		  <div class="centerPage" >
            ...
            <?php echo $form->create("prospects", array("action" => "prospectnonprofit",'name' => 'prospectnonprofit', 'id' => "prospectnonprofit")) ?>      
            <script type='text/javascript'>
            ...
            <span class="titlTxt">Non Profit Prospect</span>
            <?php }else{ echo '<span class="titlTxt">Prospect Non Profit List</span>';}?>
            <div class="topTabs">
                <ul class="dropdown">
                    <li>
					<?php
							e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'prospects','action'=>'addprospectnonprofit'),
								array('escape' => false)
								)
							);
						?>
	         ...
	         <?php    $this->loginarea="prospects";    $this->subtabsel="nonprofitlist";
        ...
        <div class="tblData">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="trBg">
                    ...
                    <th align="center" valign="middle" style='width:25%;'><span class="right"><?php echo $pagination->sortBy('company_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Non-Profit Prospect Name</th>
                ...
                <?php if($companydata){ 
                        $i=1;
						 foreach($companydata as $eachrow){						
                            ...
                            $modelname = "Company";
                            $redirectionurl = "prospectnonprofit";
							...
							$non_profit_type = $eachrow['NonProfitType']['non_profit_type_name'];
                        ...
                        <?php if($i%2 == 0) { ?>
                            <tr class='altrow'>	
                                ...
                                <td align="left" valign="middle" class='newtblbrd'>
									...
									array('controller'=>'prospects','action'=>'addprospectnonprofit',$recid,'Nonprofit'),
									array('escape' => false)
									)
								);
							?>
