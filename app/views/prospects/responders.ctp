...
{   
        ...
        {       
                ...
                if(counter!=1)
                {
                        ...
                        document.getElementById("linkedit").href=baseUrl+"prospects/addresponder/edit/"+id; 
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrl+"prospects/changestatus/"+id+"/EmailTemplate/1/responders/cngstatus";
                                                        }else{
                                                        window.location=baseUrl+"prospects/changestatus/"+id+"/EmailTemplate/0/responders/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrl+"prospects/changestatus/"+id+"/EmailTemplate/0/responders/delete";
                                        }
                        }else{
...
<div align="center" class="slider" id="toppanel">
 ...
 <?php echo $form->create("prospects", array("action" => "respondors",'type' => 'file','enctype'=>'multipart/form-data','name' => 'respondors', 'id' => "respondors"))?>
...
<div class="topTabs">
				<ul class="dropdown">
					<li><?php
							e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'prospects','action'=>'addresponder','add'),
								array('escape' => false)
								)
							);
						?></li>
					<li><a href="javascript:void(0)" class="tab2"><span>Actions</span>
						...
						<ul class="sub_menu">
							<li><a href="javascript:void(0)" onclick="return activatecontents('active','change');">Publish</a>
							</li>
							<li><a href="javascript:void(0)" onclick="return activatecontents('deactive','change');">Unpublish</a>
							</li>
           ...
           <?php    $this->loginarea="prospects";    $this->subtabsel="responders";
...
<!--inner-container starts here-->
	...
	<?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>mailautoresponderlist')" id="locaa"></span>
    ...
    <th align="center" valign="middle" style="width:28%;"><span class="right"><?php echo $pagination->sortBy('email_template_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');?></span>Template Name</th>
    <th align="center" valign="middle" style="width:17%;"><span class="right"><?php echo $pagination->sortBy('relationship_type', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');?></span>Relationship Type</th>
    ...
    <th align="center" valign="middle" style="width:10%"><span class="right"><?php echo $pagination->sortBy('active_status', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Status</th>
        ...
        <tr <?php echo ($i%2 == 0) ? "class='altrow'" :""; ?>>    
                ...
                <td align="left" valign="middle" class='newtblbrd'>
					...
					<?php
						e($html->link(
							...
							array('controller'=>'prospects','action'=>'addresponder','edit',$recid),
							array('escape' => false)
							)
						);
						?>
				...
				<td align="left" valign="middle" class='newtblbrd'>
					<?php
						e($html->link(
							$html->tag('span', ($relationshiptype)?$relationshiptype:"N/A"),
							array('controller'=>'prospects','action'=>'addresponder','edit',$recid),
							array('escape' => false)
							)
						);
         ...
         <?php } }else{ ?>
        <tr><td colspan="7" align="center">No Responder Found.</td></tr>
        <?php  } ?>
        </table>
