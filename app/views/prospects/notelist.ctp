...
<div class="container">
         <div class="titlCont">
		  <div class="centerPage" >
            ...
            <?php echo $form->create("prospects", array("url" => "notelist/$cid/$addtype",'name' => 'notelist', 'id' => "notelist")) ?>      
            <script type='text/javascript'>
            ...
            <div class="topTabs">
                <ul class="dropdown">
					...
					<?php
							...
							e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'prospects','action'=>'addnote',$action),
								array('escape' => false)
								)
							);
						?>
	         ...
	         <?php    
					  $this->loginarea="prospects";    
					  $this->subtabsel='notelist';
...
<div class="midCont" id="cmplisttab">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <?php if($notedata){ 
                        ...
                        foreach($notedata as $eachrow){
                            ...
                            if($note)	$note = AppController::WordLimiter($note,80);
                 ...
                 ?>
                        ...
                        <tr <?php echo ($i%2 == 0)? 'class="altrow"':'';?> >
                                ...
                                <td align="left" valign="middle" class='newtblbrd'>
									...
									array('controller'=>'prospects','action'=>'addnote', $recid,$cid,$addtype),
									array('escape' => false)
									)
								);
							?>
        ...
        <div>
            ...
            <div class="gryBot"><?php if($notedata) { echo $this->renderElement('newpagination'); } ?>
            </div>
            <div class="clear"></div>
        </div>
