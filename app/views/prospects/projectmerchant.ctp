		  ...
		  <div class="centerPage" >
			...
			<?php if($usertype==trim('admin')){?>
			 <span class="titlTxt1">
				...
				<span class="titlTxt">Merchants</span>
			<?php }else{ echo '<span class="titlTxt">Merchant List</span>';} ?>
...
<div class="clear"></div>
	         <?php    $this->loginarea="prospects";    $this->subtabsel="projectmerchant";
                           if($_GET['url']==='prospects/projectmerchant/2'){
        ...
        <div class="tblData">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="trBg">
                    ...
                    <th align="center" valign="middle" style='width:25%;'><span class="right"><?php echo $pagination->sortBy('company_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Merchant Prospect Name</th>
