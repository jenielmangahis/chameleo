...
$resetUrl = $base_url.'prospects/prospectemailtemplate';
?>
<script type="text/javascript">
$(document).ready(function()
{
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrl+"prospects/changestatus/"+id+"/EmailTemplate/1/prospectemailtemplate/cngstatus";
                                                        }else{
                                                        window.location=baseUrl+"prospects/changestatus/"+id+"/EmailTemplate/2/prospectemailtemplate/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrl+"prospects/changestatus/"+id+"/EmailTemplate/0/prospectemailtemplate/delete";
                                        }
                        }else{
...
<?php echo $form->create("prospects", array("action" => "prospectemailtemplate",'name' => 'prospectemailtemplate', 'id' => "prospectemailtemplate"))?>
        ...
        <div class="topTabs">
            <ul class="dropdown">
				...
				e(
					$html->link(
						$html->tag('span','New'),
						array('controller'=>'prospects','action'=>'addprospectmailtmp'),
						array('escape'=>false)
					)	
				);
				?>
...
<div class="midCont">
    ...
    <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('subject', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Subject</th>
    <th align="center" valign="middle" style="width:13%">Mail Content</th>
    <th align="center" valign="middle" style="width:8%px;"><span class="right"><?php echo $pagination->sortBy('is_sytem', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Status</th>
        ...
        <?php if($emailtemplates){
                        ...
                        $redirectionurl = "prospectemailtemplate";
                        $isdelflag = true;
        ...
        <tr <?php echo $class; ?> >
				...
				e($html->link(
					...
					array('controller'=>'prospects','action'=>'addprospectmailtmp',$recid),
					array('escape' => false)
					)
				);
				?>
