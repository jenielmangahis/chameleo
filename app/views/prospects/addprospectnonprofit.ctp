...
<span class="titlTxt">
 ...
 <div style="margin-left:5px;"><?php $this->loginarea="prospects";$this->subtabsel="projectmerchantlist";
       echo $this->renderElement('prospect_inner_submenu');  ?></div>
</div>
  ...
  <tr>
	...
	<tr>
		<td align="right" width="40%" class="lbltxtarea"><label class="boldlabel">Company Type <span style="color: red;">*</span></label></td>
				...
				<?php echo $form->select("Company.company_type_id",$nonprofitcompanytypedropdown,$selectedcompanytype,array('id' => 'company_type_id','class'=>'multilist'),"---Select---"); ?>
...
<tr>
  ...
  <tr>
			...
			<div>
				<span class="txtArea_top">
					<span class="newtxtArea_bot">
						<?php echo $form->select("Contact.contact_id",$contactdatadropdown,$companytocontact,array('id' => 'contact_id','class'=>'multilist','multiple'=>'multiple')); ?>					</span>				</span>				</div>
...
<div class="frmbox">
<table cellspacing="5" cellpadding="0" width="500px;">
...
<td align="right" width="40%" class="lbltxtarea"><label class="boldlabel">Pintrest Page <span style="color: red;"></span></label></td>
		...
		<tr>			   	
				...
				<td>
					  <div class="large" >
					  	<span class="txtArea_top">
					  		<span class="newtxtArea_bot" style="font-size:10px; padding-bottom:5px; height:150px; overflow:scroll">
