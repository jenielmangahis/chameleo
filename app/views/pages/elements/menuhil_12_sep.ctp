...
<?php }else if($actions=="super_admin_changepassword" || $actions=="help_list" ||  $actions== "mail_footer" || $actions== "getstarted" || $actions== "user_agreement_list" || $actions== "spam_policy" || $actions== "terms_by_admin"){ ?>
<script type="text/javascript">
$(document).ready(function() {
...
<?php } else if( $actions=="companylist" ||   $actions=="addcompany" ||   $actions=="contactlist" || $actions=="addcontacts" ||       $actions=="projectcompanytypes" || $actions=="projectcompanytypes_add" ||  $actions=="projectcontacttypes" ||  $actions=="projectcontacttypes_add" ||  $actions=="projectmerchantlist" ||  $actions=="projectnonprofitlist" ||  $actions=="categorylist" || $actions=="addmerchant" || $actions =="addprospectnonprofit")
{ ?>
...
<?php }else 
	if($actions=="contentlist" || $actions=="systemlist" || $actions=="addcontentpage" || $actions=="editcontent" || $actions=="settingthemes" || $actions=="page_footer" || $actions=="socialnetwork" || $actions=="fbfeeds" || $actions=="qrcodegenerate" || $actions=="bloglist" || $actions=="blogadd" ||  $actions=="formtypelist" || $actions=="formtype_add" || $actions=="formsubmitlist" || $actions=="formsubmitted"  || $actions=="formstatustypelist" || $actions=="formstatustype_add"  )
{
...
<?php }else
if( $actions=="offerlist" ||  $actions=="addoffer"){ ?>
...
<?php  } elseif( $actions=="offerlist" ||  $actions=="addoffer"){ ?>
...
if( $actions== "supermailtemplatelist" || $actions== "mailtask_list" ){ ?>
	<script type="text/javascript">
		$(document).ready(function() {
