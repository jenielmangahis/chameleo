...
<div class="titlCont1"><div style="width:960px; margin:0 auto;">
  ...
  <?php echo $form->create("Admins", array("action" => "sponsorlist",'name' => 'adminhome', 'id' => "adminhome")) ?>
...
<div style="float:left">
		...
		<span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrlAdmin+'sponsorlist')" id="locaa"></span></div><div style="float:left">  <?php
