...
{   
        ...
        {       
                ...
                if(counter!=1)
                {
                        ...
                        document.getElementById("linkedit").href=baseUrlAdmin+"editmailcontent/edit/"+id; 
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrlAdmin+"changestatus/"+id+"/EmailTemplate/1/mailautoresponderlist/cngstatus";
                                                        }else{
                                                        window.location=baseUrlAdmin+"changestatus/"+id+"/EmailTemplate/0/mailautoresponderlist/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrlAdmin+"changestatus/"+id+"/EmailTemplate/0/mailautoresponderlist/delete";
                                        }
                        }else{
...
<div class="topTabs">
<ul class="dropdown">
<!--<li><a href="/admins/addmailtemplate"><span>New</span></a></li>-->
...
<li><a href="javascript:void(0)" onclick="editcontent();" id="linkedit"><span>Edit</span></a></li>
           ...
           <?php    $this->loginarea="admins";    $this->subtabsel="mailautoresponderlist";
...
<!--inner-container starts here-->
	...
	<?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>mailautoresponderlist')" id="locaa"></span></div>
    ...
    <th align="center" valign="middle" style="width:10%"><span class="right"><?php echo $pagination->sortBy('is_sytem', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Status</th>
