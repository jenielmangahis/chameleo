    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrlAdmin +"changestatus/"+id+"/EmailTemplate/1/eventautoresponders/cngstatus";
                                                        }else{
                                                        window.location=baseUrlAdmin +"changestatus/"+id+"/EmailTemplate/0/eventautoresponders/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrlAdmin +"changestatus/"+id+"/EmailTemplate/0/eventautoresponders/delete";
                                        }
                        }else{
...
<li>
	<?php
				e($html->link(
					$html->tag('span', 'New'),
					array('controller'=>'admins','action'=>'addmailtemplate','event'),
					array('escape' => false)
					)
				);
?>
...
<!--inner-container starts here-->
	...
	<?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>eventautoresponders')" id="locaa"></span></div>
