<?php
	...
	$backUrl = $base_url_admin.'eventlist';
        ...
        <div style="height: 30px; clear:both;">
            <?php echo $form->hidden("selectedtab", array('id' => 'selectedtab')); ?>
                ...
                <ul id="tab-container-1-nav" class="topTabs2">
                  ...
                  <li>
						<!--<a href="/admins/rsvp/<?php echo $this->data['Event']['id']; ?>"><span>RSVP</span></a>-->
						

				<?php
						e($html->link($html->tag('span', 'RSVP'),				
						array('controller'=>'admins','action'=>'rsvp',$this->data['Event']['id']),
						array('escape' => false)
						)
					);
				?>
                  ...
                  <?php
                   if($waiting_list==1)  
                   {
                    ?>
                  <li>	
						<!--<a href="/admins/waitlist/<?php echo $this->data['Event']['id']; ?>"><span>Wait List</span></a>-->
						<?php
						e($html->link($html->tag('span', 'Wait List'),				
						array('controller'=>'admins','action'=>'waitlist',$this->data['Event']['id']),
						array('escape' => false)
						)
					);
				?>
...
<td width="50%" valign="top">
       ...
       <tr>
        <td>
        <div class="updat">
        <label class="boldlabel">Member Ticket Price</label>
        </div>
        ...
        <td>
        <div class="updat">
        <label class="boldlabel">Non-Member Ticket Price</label>
        </div>
