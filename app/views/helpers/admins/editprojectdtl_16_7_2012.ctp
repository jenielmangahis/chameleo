...
<?php } ?>
                       ...
                       <tr>
                        ...
                        <td style="padding-top: 0px;">
                       <span class="intpSpan"><label for="title"></label>   <?php echo $form->input("Project.next_billing_date", array('id' => 'next_billing_date','readonly' => true,'value'=> $nextBdate, 'div' => false, 'label' => '',"class" => "inpt_txt_fld","maxlength" => "200"));?>
                    </span>
