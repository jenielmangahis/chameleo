...
<h2 style="float:left;width:230px;position:absolute;padding: 0;">Welcome <?php 
 if(isset($_SESSION['User']['usertype'])=="holder")
...
<div style="float: left; position: relative;margin-left:250px;">     
<div style="float:right;height: 30px;position:relative; width: auto;" class="border_shadow" id="leftmenubar_bg">
 ...
 <table width="100%" >
	<tr>
	       ...
	       <tr>
            ...
            <table align="right" border="1" style="border:2px solid #999999; margin-top: 20px;" cellspacing="5"  width="100%" class="border_shadow">
           <tr>
            <td style="border-bottom: 1px solid black;">          
            <b>Event Invitations </b>
            </td>
...
<table align="right" border="0" style="border:2px solid #999999; width: 300px;" cellspacing="5" class="border_shadow">
<tr>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="2"><b> Profile is <?php echo $pro_complete['per'];?>% done </b></font></td>
</tr>
...
<table align="right" border="0" style="border:2px solid #999999; width: 300px;" cellspacing="0" class="border_shadow">
<tr>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
...
<table align="right" border="0" style="width: 300px;border:2px solid #999999;" cellspacing="5" class="border_shadow">
<?php
//debugbreak();
