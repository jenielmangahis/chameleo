...
<p><img alt="" src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/img/'; ?>box_top.png" width="100%" /></p>
<div align="center" class="conConts" >
	...
	<a href="<?php echo $href_coin_image; ?>" onclick="window.top.location.href = this.href" ><img  width="177" height="177"  src="<?php echo 'http://'.$_SERVER['HTTP_HOST']; ?>/img/<?php echo $dataprojects['Project']['project_name'].'/uploads/'.$coinsdetail['Coinset']['sideb']; ?>" alt="" /></a><br/>
</div>
<p><img alt="" src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/img/'; ?>box_bottom.png" width="100%" /></p>
</div>
<?php }?>