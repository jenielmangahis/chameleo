...
$resetUrl = $base_url.'mailtasks/mail_task_list';
?>
...
<?php echo $form->create("mailtask", array("action" => "mail_task_list",'name' => 'mail_task_list', 'id' => "mail_task_list"))?>
   <span class="titlTxt">Mail Tasks </span>
        <div class="topTabs" style="margin-left: -40px;">
            <ul class="dropdown">
				...
				e($html->link(
					$html->tag('span', 'New'),
					array('controller'=>'mailtasks','action'=>'mail_task','add'),
					array('escape' => false)
					)
				);
				?>
        ...
        <div class="clear"></div>
        <?php $this->mail_tasks="tabSelt"; echo $this->renderElement('superemail_submenu');?>
			...
			if($sys_ver_data){ $i=1;
                    ...
                    <tr <?php echo $class;?>>    
                        ...
                        <td align="center" valign="middle">
							<?php 
							$modalname="SystemVersion";
							$redirctaction="mail_task_list";
							if($eachrow['SystemVersion']['active_status']=='1'){
								e($html->link(
									...
									array('controller'=>'admins','action'=>'changestatus',$recid,'2',$modalname,$redirctaction),
									array('escape' => false)
									)
								);
							} else {
