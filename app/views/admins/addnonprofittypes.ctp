<?php
	...
	$backUrl = $base_url.'admins/nonprofittypelist';
...
<?php echo $form->create("admins", array("action" => "addnonprofittypes",'name' => 'addnonprofittypes', 'id' => "addnonprofittypes","onsubmit"=>"return validatenonprofittype('$act');"))?>
