...
{   
 ...
 function editcontent()
        ...
        if(counter!=1)
        {
                ...
                document.getElementById("linkedit").href=baseUrlAdmin+"ditcommtask/"+id; 
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrlAdmin+"changestatus/"+id+"/CommunicationTask/1/commtasklist/cngstatus";
                                                        }else{
                                                        window.location=baseUrlAdmin+"changestatus/"+id+"/CommunicationTask/0/commtasklist/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrlAdmin+"changestatus/"+id+"/CommunicationTask/0/commtasklist/delete";
                                        }
                        }else{
...
<div align="center" class="slider" id="toppanel">
   ...
   <?php echo $form->create("Admins", array("action" => "commtasklist",'name' => 'commtasklist', 'id' => "commtasklist")) ?>
                <script type='text/javascript'>
...
<?php
	e($html->link(
		$html->tag('span', 'New'),
		array('controller'=>'admins','action'=>'addcommtask'),
		array('escape' => false)
		)
	);
?>
...
<li><a href="javascript:void(0)" onclick="editcontent();" id="linkedit"><span>Edit</span></a></li>
            ...
            <?php    $this->loginarea="admins";    $this->subtabsel="commtasklist";
        ...
        <div class="msgBoxTopLft"><div class="msgBoxTopRht"><div class="msgBoxTopBg"></div></div></div>
	        <div class="msgBoxBg">
               ...
               <div class="new_filter">
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrlAdmin+'commtasklist')" id="locaa"></span></div>
        ...
        <tr class='altrow'>    
				...
				<?php
						e($html->link(
							...
							array('controller'=>'admins','action'=>'addcommtask','edit',$recid),
							array('escape' => false)
							)
						);
				?>
