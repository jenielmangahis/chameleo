...
<div class="titlCont">
	...
	<div class="centerPage">
      ...
      <?php  echo $this->renderElement('new_slider');  ?>
        ...
        <span class="newtitlTxt">Products By Customer</span>
        <div class="topTabs">
			<ul class="dropdown">
                <li class="">
				<?php
        ...
        <div class="clear"></div>
            <?php  
                     $this->loginarea="admins";    $this->subtabsel="projectlist_by_customer";
                    

            ?>
			<?php  if($_GET['url']==='admins/projectlist_by_customer/1'){
		    echo $this->renderElement('project_list_all_submenu');
		   } 
		   elseif($_GET['URL']==='admins/system_pricing_list/2'){
			echo $this->renderElement('product_sub');
			}
			elseif($_GET['url']==='admins/billing_status_list/2'){
			echo $this->renderElement('product_sub');
			}
			else{
		  echo $this->renderElement('product_sub');  
