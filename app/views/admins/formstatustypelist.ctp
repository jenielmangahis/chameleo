...
{   
	...
	if(counter!=1)
	{
		...
		document.getElementById("linkedit").href=baseUrlAdmin+"formstatustype_add/"+id; 
...
{   
    ...
    $('.checkid').each(function(){       
        ...
        if(id !=""){
                        if(op=="change"){       
                                if(act=="active"){
                                        window.location=baseUrlAdmin+"changestatus/"+id+"/FormSubmitStatustype/1/formstatustypelist/cngstatus";
                                        }else{
                                        window.location=baseUrlAdmin+"changestatus/"+id+"/FormSubmitStatustype/0/formstatustypelist/cngstatus";
                                        }
                        }
                        if(op=="del"){
                        if(confirm("You have selected "+count +" items to delete ?"))
                         ...
                         if(confirm("Are You Sure to delete the item"))
                            window.location=baseUrlAdmin+"changestatus/"+id+"/FormSubmitStatustype/0/formstatustypelist/delete";
                       }
}else{
...
<li>
	...
	<?php
				e($html->link(
					$html->tag('span', 'New'),
					array('controller'=>'admins','action'=>'formstatustype_add'),
					array('escape' => false)
					)
				);
?>
    ...
    <div class="gryTop">
		<div class="new_filter">
					<span class="spnFilt">Filter:</span><span class="srchBg"><?php echo $form->input("searchkey", array('id' => 'searchkey', 'div' => false, 'label' => '',"maxlength" => "200"));?></span><span class="srchBg2"><?php echo $form->submit("Go", array('id' => 'searchkeysubmit', 'div' => false, 'label' => ''));
								...
								<span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>formstatustypelist')" id="locaa"></span>
		</div>
                    </div>	
...
<?php $i=1; ?>			
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
	               ...
	               <th align="center" valign="middle" width="80%">Status Type <span class="right">
                   <?php echo $pagination->sortBy('statustype_name',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?>
                   </span></th>
                   <th align="left" valign="middle" width="17%">Status<span class="right">
   	...
   	<?php if($statustypedata){ 
            ...
            $redirectionurl = "formstatustypelist";   
   	...
   	<tr <?php echo $class;?>>	
		...
		<td align="center"><a href="/admins/formstatustype_add/<?php echo $recid?>" ><span><?php echo $i++;?></span></a></td>
		...
		<?php
				e($html->link(
					...
					array('controller'=>'admins','action'=>'formstatustype_add',$recid),
					array('escape' => false)
					)
				);
		?>
