...
{   
        ...
        {       
                ...
                if(counter!=1)
                {
                        ...
                        document.getElementById("linkedit").href=baseUrlAdmin+"editmailcontent/"+id; 
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrlAdmin+"changestatus/"+id+"/EmailTemplate/1/mailtemplatelist/cngstatus";
                                                        }else{
                                                        window.location=baseUrlAdmin+"changestatus/"+id+"/EmailTemplate/0/mailtemplatelist/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrlAdmin+"changestatus/"+id+"/EmailTemplate/0/mailtemplatelist/delete";
                                        }
                        }else{
...
<div align="center" class="slider" id="toppanel">
 ...
 <?php echo $form->create("Admins", array("action" => "mailtemplatelist",'type' => 'file','enctype'=>'multipart/form-data','name' => 'contentlist', 'id' => "mailtemplatelist"))?>
...
<li>
	<?php
				e($html->link(
					$html->tag('span', 'New'),
					array('controller'=>'admins','action'=>'addmailtemplate'),
					array('escape' => false)
					)
				);
?>
...
<!--inner-container starts here-->
	...
	<?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrlAdmin+'mailtemplatelist')" id="locaa"></span></div>
    ...
    <th align="center" valign="middle" style="width:28%;"><span class="right"><?php echo $pagination->sortBy('email_template_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
 ?></span>Template Name</th>
    <th align="center" valign="middle" style="width:28%;"><span class="right"><?php echo $pagination->sortBy('subject', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
 ?></span>Subject</th>
    <th align="center" valign="middle" style="width:15%">Mail Content</th>
    <th align="center" valign="middle" style="width:12%;"><span class="right"><?php echo $pagination->sortBy('is_sytem', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
 ?></span>Status</th>
        ...
        <tr class='<?php echo $clN ?>'>    
                ...
                <td align="left" valign="middle" class='newtblbrd'>
						...
						e($html->link(
							...
							array('controller'=>'admins','action'=>'editmailcontent','edit',$recid),
							array('escape' => false)
							)
						);
						?>
...
<script language='javascript'>
        function showcontentwindow(id){
                var url = '/admins/showcontentwindow/'+id+'/EmailTemplate';          
