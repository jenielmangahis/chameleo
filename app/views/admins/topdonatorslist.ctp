...
<script type="text/javascript">
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){	
                if(act=="active"){
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Holder/1/topdonatorslist/cngstatus";
                }else{
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Holder/0/topdonatorslist/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Holder/0/topdonatorslist/delete";
            }
        }else{
...
<div class="container">
	  ...
	  <div class="centerPage">
            ...
            <?php echo $form->create("Admin", array("action" => "topdonatorslist",'name' => 'topdonatorslist', 'id' => "topdonatorslist")) ?>
          ...
          <!--   <div class="topTabs">
             ...
             <?php    $this->loginarea="admins";    $this->subtabsel="topdonatorslist";
...
<div class="midCont" id="newhldtab">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2">
                <input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrlAdmin+'topdonatorslist')" id="locaa">&nbsp;&nbsp;  

            </span><span class="srchBg2"><input type="button" value="Csv file download" label="" onclick="javascript:(window.location=baseUrlAdmin+'downloadholder')" > </span></div>
    ...
    <div class="tblData">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr class="trBg">
                ...
                <th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('created', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Register Date</th>
                <th align="center" valign="middle" style="width:11%"><span class="right"><?php echo $pagination->sortBy('firstname', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');?></span>First Name</th>
                <th align="center" valign="middle" style="width:11%"><span class="right"><?php echo $pagination->sortBy('lastnameshow', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Last Name</th>
                <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('screenname', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Screen Name</th>
                <th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('member_type', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');?></span>Member Type</th>
                <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('donation_level', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Donation Level</th>
                ...
                <th align="center" valign="middle" style="width:11%"><span class="right"><?php echo $pagination->sortBy('active_status ', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Status</th>
            </tr>
            <?php $i=1;?>
            <?php if($memberlist){
                    $created="";              
                    ...
                    <tr class='<?php echo $cls; ?>'>    
							...
							e($html->link(
								...
								array('controller'=>'admins','action'=>'changestatus',$recid,$modelname,'1',$redirectionurl,'cngstatus',$othermodelname,$userid),
								array('escape' => false)
								)
							);
						}
