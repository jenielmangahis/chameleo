...
<div class="container">
    ...
    <div class="tblData">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg">
                ...
                <th align="center" valign="middle" style="width:150px"><span class="right"><?php echo $pagination->sortBy('date', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Date</th>
                <th align="center" valign="middle" style="width:150px"><span class="right"><?php echo $pagination->sortBy('member_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Member Name</th>
                <th align="center" valign="middle" style="width:150px"><span class="right"><?php echo $pagination->sortBy('action_type', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Action Type</th>
                <th align="center" valign="middle" style="width:150px"><span class="right"><?php echo $pagination->sortBy('level', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Level</th>
                <th align="center" valign="middle" style="width:150px"><span class="right"><?php echo $pagination->sortBy('points', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Points</th>                
            </tr>
            <?php $i=1;?>
            <?php if($points_arr){
    ...
    <div class="gryBot"><?php //if($points_arr) { 
