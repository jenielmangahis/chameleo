...
<script type="text/javascript">
    $(document).ready(function() { 
        ...
        if(msgid >0 ){
            $.ajax({
                                url: 'http://'+current_domain+'/admins/message_reply_by_ajax/'+msgid,
                                cache: false,
...
<div class="titlCont1"><div style="width:960px; margin:0 auto;">
        ...
        <div class="topTabs">
            <ul>
            <?php if($msgholder){  ?>
                  <li><button type="button" id="saveForm" class="button"  ONCLICK="javascript:(window.location='/admins/membermessages/<?php echo $msgholder;?>')"><span> Cancel</span></button></li>
            <?php }else{ ?>
                            ...
                            <span class="txtArea_bot">
                                ...
                                <option value="0">Dashboard</option>   
                                    <?php if($holderlist){
                                            ...
                                            ?>
                                            <option value="<?php echo $holderdata['Holder']['user_id']."-".$holderdata['Holder']['screenname'];?>"><?php echo $holderdata['Holder']['screenname'];?></option> 
                                            <?php     } }?>
            ...
            <div id="message"  style="width:100%;">
                <div class="blogarticle margin4px">
                    <div class="" style=" margin: 4px;"> 
                        <a style=" font-size: 14px;     padding-left: 0;    text-decoration: none;" id="blogtitle" title="<?php echo $msgInfo['Message']['msg_subject'];?> " href="/admins/messagesnew/<?php echo $msgInfo['Message']['id'];?> " style=""> 
