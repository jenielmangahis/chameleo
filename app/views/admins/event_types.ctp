...
<script type="text/javascript">
    ...
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrlAdmin+"addeventtype/"+id; 
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){       
                if(act=="active"){
                    window.location=baseUrlAdmin+"changestatus/"+id+"/EventType/1/event_types/cngstatus";
                }else{
                    window.location=baseUrlAdmin+"changestatus/"+id+"/EventType/0/event_types/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrlAdmin+"changestatus/"+id+"/EventType/0/event_types/delete";
            }
        }else{
...
<div class="container">
   ...
   <div class="centerPage">
            ...
            <?php echo $form->create("Admin", array("action" => "event_types",'name' => 'event_types', 'id' => "event_types")) ?>
            <script type='text/javascript'>
                ...
                <ul class="dropdown">
                      <li>
						...
						<?php
							e($html->link(
							$html->tag('span', 'New'),
							array('controller'=>'admins','action'=>'addeventtype'),
							array('escape' => false)
							)
						);
					?>
...
<div class="midCont">
    ...
    <div>
		...
		<div class="new_filter">
            ...
            <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>event_types')" id="locaa"></span>
                        ...
                        <td align="left" valign="middle">
							...
							<?php
								e($html->link(
									...
									array('controller'=>'admins','action'=>'addeventtype',$recid),
									array('escape' => false)
									)
								);
							?>
