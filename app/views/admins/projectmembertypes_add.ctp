...
<?php echo $form->create("Admins", array("action" => "projectmembertypes_add",'name' => 'projectmembertypes_add', 'id' => "projectmembertypes_add",'onsubmit' => 'return validateMemberType("add");'));
