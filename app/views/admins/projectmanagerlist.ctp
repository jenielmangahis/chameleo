...
<div class="titlCont">
	<div class="centerPage">
      ...
      <?php  echo $this->renderElement('new_slider');  ?>
        ...
        <span class="newtitlTxt">Projects Manager</span>
        
        
        <div class="clear"></div>
           <?php  
		   if($_GET['url']==='admins/projectlist/1'){
		    echo $this->renderElement('project_list_all_submenu');
		   }
		   elseif($_GET['url']==='legals/user_agreehistory'){
		  echo $this->renderElement('project_list_all_submenu'); 
		   }
		   else{
...
<div class="tblData">
	...
	if($projectdata){ 
		...
		e($html->link(
			...
			array('controller'=>'admins','action'=>'project_manager',$recid),
			array('escape' => false)
			)
		);
		?>
