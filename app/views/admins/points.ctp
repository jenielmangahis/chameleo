...
<!-- Body Panel starts -->
 <div class="titlCont"><div class="centerPage">
            ...
            <?php echo $form->create("admins", array("action" => "points",'name' => 'points', 'id' => "points",'enctype'=>'multipart/form-data')); ?> 
            ...
            <div class="topTabs">
                ...
                <li><button type="submit" value="Submit" class="button" name="data[Action][noredirection]"><span>Apply</span></button></li>
                   ...
                   <?php    $this->loginarea="admins";    $this->subtabsel="points";
        ...
        <table cellspacing="10" cellpadding="0" align="center" width="100%">
                ...
                $j=0; 
                 ...
                 for($i=1;$i<=10;$i++)
                 {
                     ...
                     if($points_awards_info[$j]['points_awards']['is_active']==1)
                        $checked="true";
                        else
                        $checked="false";
                ...
                <td><?php echo $form->input("point_award_".$i,array('label'=>false,'type'=>'text','value'=>$points_awards_info[$j]['points_awards']['points_required'],'size'=>'6   ','style'=>'border: 1px solid #026789;')) ?></td>
