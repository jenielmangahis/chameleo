...
<div class="tblData">
		...
		<th align="center" valign="middle" style="width:2%"><input type="checkbox" id="checkall" name="checkall" value=""></th>
	        ...
	        <th align="center" valign="middle" style="width:25%"><span class="right"><?php echo $pagination->sortBy('is_3rdparty', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'CompanyType',null,' ',' '); ?></span>Is 3rd party?</th>
			<th align="center" valign="middle" style="width:25%"><span class="right"><?php echo $pagination->sortBy('company_type_status_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'CompanyTypeStatus',null,' ',' '); ?></span>Company Type Status</th>
     		<th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('active_status', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'CompanyType',null,' ',' '); ?></span>Status</th>
		...
		<td align="left" class='newtblbrd' valign="middle">
			<?php
				e($html->link(
					...
					array('controller'=>'admins','action'=>'editcompanytype',$recid),
					array('escape' => false)
					)
				);
			?>
