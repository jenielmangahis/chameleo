...
$resetUrl = $base_url_admin.'ownerlist';
$this->ownerlist="tabSelt";
?>
...
<div class="titlCont"><div class="centerPage">
  ...
  <?php echo $form->create("Admins", array("action" => "ownerlist",'name' => 'adminhome', 'id' => "adminhome")) ?>
        ...
        <div class="clear"></div>
           <?php  echo $this->renderElement('project_list_all_submenu');  ?>
</div></div>
...
<div class="tblData">
   	...
   	if($projectdata){ 
		...
		echo $count++ ?></td>
		<td align="center" valign="middle" class='newtblbrd'><input type="checkbox" value="<?php echo $recid; ?>" name="checkid[]" class="checkid" alt="<?php echo $pid; ?>"></td>
