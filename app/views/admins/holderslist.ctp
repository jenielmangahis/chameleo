...
<div class="container">
       <div class="titlCont"><div class="centerPage">
            ...
            <?php echo $form->create("Admin", array("action" => "holderslist",'name' => 'holderslist', 'id' => "holderslist")) ?>
            <script type='text/javascript'>
            ...
            <span class="titlTxt">   Coin Holders  </span>
            ...
            <div class="topTabs">
				...
				<?php
					e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'admins','action'=>'addholder'),
								array('escape' => false)
								)
					);
				?>
             ...
             <?php    $this->loginarea="admins";    $this->subtabsel="holderslist";
...
<div class="midCont" id="newhldtab">
    ...
    <div>
        ...
        <div class="gryTop">            
            ...
            <span class="srchBg2">
                <input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrlAdmin+'holderslist')" id="locaa">&nbsp;&nbsp;  
            </span><span class="srchBg2"><input type="button" value="Csv file download" label="" onclick="jjavascript:(window.location=baseUrlAdmin+'downloadholder')" > </span></div>
    ...
    <div class="tblData">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <th align="center" valign="middle" style="width:8%"><span class="right"><?php echo $pagination->sortBy('points', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Points</th>
                <th align="center" valign="middle" style="width:10%"><span class="right"><?php echo $pagination->sortBy('active_status ', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Status</th>
            </tr>
            <?php $i=1;?>
            <?php if($holderlist){
                    ...
                    <?php } }else{ ?>
                <tr><td colspan="10" align="center">No Holders Found.</td></tr>
                <?php  } ?>
    ...
    <div class="gryBot"><?php //if($holderlist) { 
