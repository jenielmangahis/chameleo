...
<div class="topTabs" style="margin-left: -40px;">
        <ul class="dropdown">
            ...
            <div class="clear"></div>
           <?php  
             $this->loginarea="admins";    $this->subtabsel="coinset_orders_approved_changes";
             echo $this->renderElement('coin_order_sub');  
           ?>
        </div></div>
<div class="midCont">
...
<div class="tblData">
     ...
     <th align="center" valign="middle"><span class="right"><?php echo $pagination->sortBy('coinset_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
 ?></span>Coinset #</th>
     <th align="center" valign="middle"><span class="right"><?php echo $pagination->sortBy('numunits',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
 ?></span># of units</th>
     <th align="center" valign="middle"><span class="right"><?php echo $pagination->sortBy('datesubmitchipco',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
 ?></span>Order Date</th>
     <th align="center" valign="middle"><span class="right"><?php echo $pagination->sortBy('dateestship', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
 ?></span>Ship Date</th>
     <th align="center" valign="middle"><span class="right"><?php echo $pagination->sortBy('dateestdelivery',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
 ?></span>Received Date</th>
     <th align="center" valign="middle"><span class="right"><?php echo $pagination->sortBy('active_status', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
 ?></span>Status</th>
      </tr>
    ...
    $alt=0;
            ...
            if($alt%2==0)
               ...
               $modelname = "Coinset";
               $redirectionurl = "coinset_orders_approved_changes";
               $notetext = "";
       ...
       <tr <?php echo $class;?>>    
        <td align="left" valign="middle"><a><span><?php echo $i++ ?></span></a></td><td align="left" valign="middle"><input type="checkbox" value="<?php echo $recid; ?>" name="checkid[]" class="checkid"></td>
                <td align="left" valign="middle"  width="18%"><a href="http://<?php echo $current_url."/admins/editcoinset_order/".$eachrow['Coinset']['id'] ;?>"><span><?php echo $eachrow['Coinset']['project_name']; ?></span></a></td>
    ...
    <?php } }else{ ?>
    <tr><td colspan="9" align="center">No Coinset List Found.</td></tr>
    <?php } ?>
    </table>
...
{   
        ...
        if(counter!=1)
        {
                ...
                document.getElementById("linkedit").href="/admins/editcoinset_order/"+id; 
...
{       
        ...
        if(id !=""){
                        if(op=="change"){       
                                if(act=="active"){
                                        window.location="/admins/changestatus/"+id+"/Coinset/1/coinset_orders_approved_changes/cngstatus";
                                        }else{
                                        window.location="/admins/changestatus/"+id+"/Coinset/0/coinset_orders_approved_changes/cngstatus";
                                        }
                        }
                        if(op=="del"){
            if(confirm("Are ou ure to delete the item ?"))
                        window.location="/admins/changestatus/"+id+"/Coinset/0/coinset_orders_approved_changes/delete";
                        }
        }else{
