...
<span class="titlTxt1"><?php echo $project['Project']['project_name'];  ?>:&nbsp;</span> 
        ...
        <div class="topTabs">
            <ul>
				<?php if($current_project_name){ ?>
                <li><button type="submit" value="Submit" class="button" name="data[Action][redirectpage]"><span>Save</span></button></li>
                <li><button type="submit" value="Submit" class="button" name="data[Action][noredirection]"><span>Apply</span></button></li>
				<?php } ?>		
                <li><button type="button" id="saveForm" class="button"  ONCLICK="javascript:(window.location='<?php echo $base_url_admin ?>formtypelist')"><span> Cancel</span></button></li>
            </ul>
        </div>
   ...
   <div class="">
        ...
        <div class="">
            ...
            <div class="">	
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <table  width="100%">
								...
								<tr valign="top">
                            <td  valign="top" width="15%" style="padding-top: 4px;"> <label class="boldlabel">Status Type </label></td>
                            <td width="50%">
                                     <span class="txtArea_top">
                                <span class="txtArea_bot">
                                      <?php echo $form->select('FormType.status_type',$formstatustypedropdown, $selectedstatustype,array('id'=>'status_type','empty'=>false,'class'=>'multilist multi'),"---Select---");?>
                                </span>
                                </span>
				...
				$('#releationship_type').live('change', function(){  
					getresponder();     		
				});
				function getresponder(){
					$.ajax({
	                    url: baseUrl+'/admins/ajax_get_responders_by_relationshiptype/'+$('#releationship_type').val()+'/<?php echo $sel_responce;?>',
	                    dataType:'html',
	                    cache: false,
	                    success: function(data){
	                              $("#emailtemplate_toresponce").html(data);
	                    }
	      			});
				}
					</script>
			<?php 
				echo $form->select("FormType.releation_type",$common->getrelationshiptype(0,'drp'), $releation_type, array('id' => 'releationship_type','class'=>'multilist'),"---Select---");?>
			    </span>
					</span>
						</span>
                       ...
                       <tr  valign="top">
                        ...
                        <tr  valign="top">
                         ...
                         <tr>
                          ...
                          <!-- We use this later after implementation of company type and contact type to project sposnor --->
