...
<div class="titlCont"><div class="centerPage">
         ...
         <span class="titlTxt">Orders Submitted </span>
<div class="topTabs" style="margin-left: -40px;">
        <ul class="dropdown">
            ...
            <div class="clear"></div>
            <?php  
                $this->loginarea="admins";    $this->subtabsel="coinset_orders";
...
<div class="tblData">
     ...
     <th align="center" valign="middle"><span class="right"><?php echo $pagination->sortBy('coinset_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');?></span>Coinset #</th>
                ...
                <td align="left" valign="middle"  width="18%">
					<?php
						e($html->link(
							...
							array('controller'=>'admins','action'=>'editcoinset_order',$eachrow['Coinset']['id']),
							array('escape' => false)
							)
						);
						?>
...
{       
        ...
        if(id !=""){
                        if(op=="change"){       
                                if(act=="active"){
                                        window.location="/admins/changestatus/"+id+"/Coinset/1/coinset_orders/cngstatus";
                                        }else{
                                        window.location="/admins/changestatus/"+id+"/Coinset/0/coinset_orders/cngstatus";
                                        }
                        }
                        if(op=="del"){
            if(confirm("Are you sure to delete the item ?"))
                        window.location="/admins/changestatus/"+id+"/Coinset/0/coinset_orders/delete";
                        }
        }else{
