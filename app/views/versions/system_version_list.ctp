...
<div class="titlCont">
  <div class="centerPage">	
    ...
    <div class="clear"></div>
    <?php $this->system_version_list="tabSelt"; echo $this->renderElement('product_sub');?>
  </div>
</div>
<div class="midCont">
  ...
  <div>
    ...
    <div class="gryTop"> <?php echo $form->create("versions", array("action" => "system_version_list",'name' => 'system_version_list', 'id' => "system_version_list")) ?>
	  ...
	  <span class="spnFilt">Filter:</span><span class="srchBg"><?php echo $form->input("searchkey", array('id' => 'searchkey', 'div' => false, 'label' => '',"maxlength" => "200"));?></span><span class="srchBg2"><?php echo $form->submit("Go", array('id' => 'searchkeysubmit', 'div' => false, 'label' => ''));?></span> <span class="srchBg2">
