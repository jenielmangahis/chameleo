...
$backUrl = Configure::read('App.base_url').'versions/system_version_list';
?>
<div class="container">
<div class="titlCont"><div class="centerPage">
    ...
    <?php echo $form->create("versions", array('controller'=> 'versions',"action" => "system_version/add",'name' => 'system_version', 'id' => "system_version",'onsubmit' => 'return validateVersionAdd();'));
	...
	?>
        ...
        <div class="topTabs">
		 ...
		 <div class="clear"></div>
    <?php echo $this->renderElement('product_sub'); ?>
    ...
    <div class=""><a href="javascript:void(0);" onclick="hideDiv();"><img src="/img/close.png" alt="" style="margin-left: 945px;position: absolute;z-index: 11;" /></a>
                ...
                <table width="395px" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
						...
						<td>
								<?php echo $form->error('SystemVersion.system_version_name', array('class' => 'errormsg'));?>
						</td>
                    </tr>
