...
?>
<table id="loading_image"  width="100%" style="height: 100%;"><tr style="height: 540px;" ><td align="center"><img src="../img/ajax-pageloader.gif" alt="Imagecoins:pageloader" /></td></tr></table>
