                                ...
                                <?php 
                                    if(isset($eventdata)){
                                         ...
                                         */
                                         ...
                                         if($member_type==$session_member_type || $member_type=="0")
                                           ...
                                           if($show_to_member_type==1)
                                           {
                                            ...
                                            if( ($eachrow['RecurringEvent']['show_to_invitees_only']==1 && $show_to_invitees_only==1) || $eachrow['RecurringEvent']['show_to_invitees_only']==0)
                                            {
                                                ?>
                                            <div class="blogarticle margin4px">
												...
												<?php
												e($html->link(
													$eachrow['RecurringEvent']['event_title'],
													array('controller'=>'companies','action'=>'events',0,$eachrow['RecurringEvent']['id']),
													array('escape' => false,'title'=> $eachrow['RecurringEvent']['event_title'],'id'=>'blogtitle')
													)
												);
												?>
												</div>

                                                <div class="grayText margin4px">
												At <?php echo $eachrow['RecurringEvent']['location']; ?> 
												on <?php echo date("F d, Y", strtotime($eachrow['RecurringEvent']['start_date'])); ?> 
												| <?php 
												echo (isset($eachrow[0]['commentcount']))?$eachrow[0]['commentcount']:0; ?> Comments</div>
                                                <div class="margin4px">
													...
													e($html->link(
														'Read More',
														array('controller'=>'companies','action'=>'events',0,$eachrow['RecurringEvent']['id']),
														array('escape' => false,'title'=>$eachrow['RecurringEvent']['event_title'],'class'=>'orangeText')
														)
													);
													?>
													</span>
                                            ...
                                            {
                                        ?>
                                        <div style="float: right;"><a href="/companies/events/<?php echo $eventlimit+$eventoffset; ?>" id="morecomment" >More Events</a> </div>
                                        <?php
                                            }
                                        }
                                        else{
                                       ...
                                       <br /><br />
                                         ...
                                         <div class="margin4px" style="float: left; position: relative; width: 25%; text-align:center"> 
                                        <?php
                                            if($eventrow['RecurringEvent']['small_pic'] !=''){
												echo $html->image('/img/'.$project_name.'/uploads/'.$eventrow['RecurringEvent']['small_pic'], array('class'=>'','align'=>'top'));
											} else {
												echo $html->image('/img/'.$project_name.'/nologo.jpg', array('class'=>'','align'=>'top','width'=>'150','height'=>'150'));
											}
										?> 
                                                    <div class="margin4px" style="padding-top: 20px; width: 220px; text-align:left">
                                                    <b>Description:</b>
                                        ...
                                        <div class="blogarticle margin4px" style="float: left; position: relative; width: 35%;">
                                            ...
                                            {                                               
                                                 ...
                                                 if($eventrow['RecurringEvent']['rsvp_required']==1)
                                                 {
                                                ?>
                                            <div class="margin4px">
                                            <span class="flx_button_lft_red ">
<?php echo $form->button($head, array('div'=>false,"class"=>"flx_flexible_btn_red",'style'=>'font-size:12px;','onclick'=>"window.open('/companies/rsvp/".$eventrow['RecurringEvent']['id']."','windowname1','width=750, height=450,resizable=no,scrollbars=1'); return false;"));?> 
                                             </span>&nbsp;<font size="1"><b>Please tell us if you can attend</b></font>
                                             </div>
                                             <?php
                                                 }
                                            }
                                             ...
                                             <div class="margin4px"><div style="padding-left: 24px;"><b>RSVP Required:</b>&nbsp;&nbsp;<?php if($eventrow['RecurringEvent']['rsvp_required']==1) echo"Yes"; else echo "No"; ?>  </div> </div>
                                              ...
                                              <div id="leavecomment">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="hidden" id="event_id" name="event_id" value="<?php echo  $eventrow['RecurringEvent']['id']; ?>"/>
                                                    </div>
                                                    <br />
                                                    &nbsp;&nbsp;
