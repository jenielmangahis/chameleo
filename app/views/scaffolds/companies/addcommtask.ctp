...
<div align="center" class="slider" id="toppanel" style="height: 15px;">
 ...
 <span class="titlTxt"> Add E-mail Task </span>
...
<li><button type="button" id="saveForm" class="button"  ONCLICK="javascript:(window.location=baseUrl+'companies/addcommtask')"><span> Cancel</span></button></li>
</ul>
</div>



     <?php    $this->loginarea="companies";    $this->subtabsel="addcommtask";
...
?> 
  <div id="loading" style="position:absolute; width:100%; text-align:center; top:250px;">
	...
	<?php e($html->image('ajax-pageloader.gif',array('alt'=>'Imagecoins:pageloader')));?>
</div>
<?php } ?>
  <div class="clear"></div>  
<div class="midPadd" id="sndmail">
    <?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>          
        ...
        <div id="addcomm" class="" style="border:none; display:block;">          
                                    ...
                                    <table width="100%">
                                        <tbody>
                                                ...
                                                <td width="174px" align="right" >
                                                 ...
                                                 <td>
                                                <span class="intpSpan middle"><?php echo $form->text("CommunicationTask.member_zipcode_from", array('id' => 'member_zipcode_from', 'div' => false, 'label' => '',"class" => "inpt_txt_fld","style" => "width:125px","maxlength" => "200"));?></span>&nbsp; to  &nbsp;
                                ...
                                <span class="txtArea_bot">
                                  ...
                                  <tr>
                                    <td align="right" >
                                     ...
                                     <td>
                                    <span class="intpSpan middle"><?php echo $form->text("CommunicationTask.member_points_rangefrom", array('id' => 'member_points_rangefrom', 'div' => false, 'label' => '',"class" => "inpt_txt_fld","style" => "width:100px","maxlength" => "200"));?></span>&nbsp; to  &nbsp;
                                    <span class="intpSpan middle"><?php echo $form->text("CommunicationTask.member_points_rangeto", array('id' => 'member_points_rangeto', 'div' => false, 'label' => '',"class" => "inpt_txt_fld","style" => "width:100px","maxlength" => "200"));?></span>
                                    </td>
                                </tr>
                    ...
                    <td width="45%" valign="top">
                        <table cellspacing="10" cellpadding="0" align="center" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <?php /*if(isset($eachrow['CommunicationTask']['active_status'])=='0'){ 
                                    								e($html->link(
								$html->image('active.gif',array('width'=>'10','height'=>'13','alt'=>'','title'=>'Click here to deactivate ')),
								array('controller'=>'companies','action'=>'changestatus','0','cngstatus'),
								array('escape' => false)
								)
							);
							}else{
									e($html->link(
											...
											array('controller'=>'companies','action'=>'changestatus','1','cngstatus'),
											array('escape' => false)
											)
										);
							}  */
    ...
    $(function() {
       ...
       $( "#runreport" ).click(function() {  // runTaskReport();
            ...
            $.ajax({
                            ...
                            url: baseUrl+'companies/commtask_get_report_list_by_ajax/',
                            cache: false,
 ...
 /**          
         ...
         */
         function addEmailTempforTask() {   
             ...
             var resWindow=  window.open (baseUrl+'companies/addmailtemplate/popup', 'AddTemp','location=1,status=1,scrollbars=1, width=950,height=650');
             resWindow.focus();
           }
         ...
         */
         function addCommentTypeforTask() { 
             ...
             var resWindow=  window.open (baseUrl+'companies/addcommenttype/popup', 'AddCommentType','location=1,status=1,scrollbars=1, width=950,height=650');
             resWindow.focus();
           }
        ...
        */
        function getcommenttypesbyajax(projectid,eleid, selectedid) {    
               ...
               jQuery.ajax({
                     type: "GET",
                     url: baseUrl+'companies/getcommenttypesbyajax/'+projectid+'/'+selectedid,
                     cache: false,
        ...
        function runTaskReport(){
            var current_domain=$("#current_domain").val();  
              ...
              $.ajax({
                            type: "GET",  
                            url: baseUrl+'companies/commtask_get_report_list_by_ajax/all',
                            cache: false,
                            success: function(result){      
                                      $("#showtaskreport").html(result); 
                                    //   $( "#showtaskreport" ).dialog( "open" );  
