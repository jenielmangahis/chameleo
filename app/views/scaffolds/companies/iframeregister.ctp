    ...
    <div>
       ...
       <div style="display:<?php if($status=='Verified') echo 'block'; else echo 'none'; ?>" >
        ...
        <div class="rhtFrmCont " style="width:395px;">
            ...
            <label class="frmLbls frmLbl2" style="width:137px;">Create Screen Name</label><span class="intpSpan"><?php echo $form->input('screenname',array('label'=>'','div'=>false,'type'=>"text",'id'=>'screenname' , 'class'=>'inpt_txt_fld','value'=>isset($holder_data['Holder']['screenname'])?$holder_data['Holder']['screenname']:'')); // ,'onblur'=>'return error_name();' updateCoin ?></span><br />

                <label class="frmLbls frmLbl2" style="width:137px;">Your Email</label><span class="intpSpan"><?php echo $form->input('email',array('label'=>'','div'=>false,'type'=>"text",'id'=>'email' , 'class'=>'inpt_txt_fld','value'=>isset($holder_data['Holder']['email'])?$holder_data['Holder']['email']:'')); // ,'onblur'=>'return error_email();' ?></span><br />
...
$plus = new Google_PlusService($client);
  ...
  print "<a class='border_shadow' href='$authUrl' target='_parent' ><img src='/images/google_sigup.png' alt='Google Sign up!' /></a>";
...
?>
		 ...
		 <a href="<?php echo $base_url ?>companies/facebooklogin" target="_parent"> Facebook</a>
            <br /><br />
            <p><a href="/companies/twitter_login?oauth_token" target="_parent" ><img src="/images/twitter_login.png" alt="Twitter Sign up!" /></a></p>
            <br/>
            <br/>
