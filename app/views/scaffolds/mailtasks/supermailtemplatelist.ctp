...
$resetUrl = $base_url.'mailtasks/supermailtemplatelist';
?>
<script type="text/javascript">
$(document).ready(function()
{
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrl+"mailtasks/changestatus/"+id+"/EmailTemplate/1/supermailtemplatelist/cngstatus";
                                                        }else{
                                                        window.location=baseUrl+"mailtasks/changestatus/"+id+"/EmailTemplate/2/supermailtemplatelist/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrl+"mailtasks/changestatus/"+id+"/EmailTemplate/0/supermailtemplatelist/delete";
                                        }
                        }else{
...
<?php echo $form->create("mailtasks", array("action" => "supermailtemplatelist",'name' => 'supermailtemplatelist', 'id' => "supermailtemplatelist"))?>
   <span class="titlTxt">Mail Templates </span>
        <div class="topTabs" style="margin-left: -40px;">
            <ul class="dropdown">
				...
				e(
					$html->link(
						$html->tag('span','New'),
						array('controller'=>'mailtasks','action'=>'addsupermailcontent'),
						array('escape'=>false)
					)	
				);
				?>
        ...
        <div class="clear"></div>
        <?php $this->mailtempaltes="tabSelt";  echo $this->renderElement('superemail_submenu');?>  
...
<div class="midCont">
    ...
    <th align="center" width="2%"><input type="checkbox" value="" name="checkall" id="checkall" /></th>
	    <th align="center" valign="middle" style="width:10%"><span class="right"><?php echo $pagination->sortBy('email_template_type', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Template Type</th>
    ...
    <th align="center" valign="middle" style="width:7%"><span class="right"><?php echo $pagination->sortBy('is_sytem', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Status</th>
        ...
        <?php if($emailtemplates){
                        ...
                        $redirectionurl = "supermailtemplatelist";
                        $isdelflag = true;
        ...
        <tr <?php echo $class; ?> >
				...
				<?php
				e($html->link(
					$html->tag('span', $emailtemplatestype),
					'#',
					array('escape' => false)
					)
				);
				...
				e($html->link(
					...
					array('controller'=>'mailtasks','action'=>'addsupermailcontent',$recid),
					array('escape' => false)
					)
				);
				?>
