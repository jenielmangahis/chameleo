...
<div class="container">
    <div class="titlCont">
        <div class="centerPage">
            ...
            <?php echo $form->create("contacts", array("action" => "projectcontacttypes",'name' => 'projectcontacttypes', 'id' => "projectcontacttypes")); ?> 
            ...
            <div class="topTabs">
                    <ul class="dropdown">
							...
							e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'contacts','action'=>'projectcontacttypes_add'),
								array('escape' => false)
								)
							);
						?>
            ...
            <?php    $this->loginarea="contacts";    $this->subtabsel="projectcontacttypes";
...
<div class="midCont" id="newcoinsettab">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'contacts/projectcontacttypes')" id="locaa"></span>
    ...
    <div class="tblData">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg"> 
                ...
                <th align="center" valign="middle" style="width:70%"><span class="right"><?php echo $pagination->sortBy('contact_type_name',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Contact Type</th>
                <th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('active_status', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Status</th>
            </tr>
            <?php 
                        ...
                        <tr class='altrow'>
                            ...
                            <td align="left" class='newtblbrd' valign="middle">
								<?php
									...
									array('controller'=>'contacts','action'=>'projectcontacttypes_add',$recid),
									array('escape' => false)
									)
								);
							?>
                            ...
                            <td align="center" valign="middle" class='newtblbrd'><?php if($eachrow['ContactType']['active_status']=='1'){ 
								e($html->link(
									...
									array('controller'=>'contacts','action'=>'changestatus',$recid,$modelname,'0',$redirectionurl,'cngstatus'),
									array('escape' => false)
									)
								);
							}
								...
								e($html->link(
									...
									array('controller'=>'contacts','action'=>'changestatus',$recid,$modelname,'1',$redirectionurl),
									array('escape' => false)
									)
								);
							}		
...
<script type="text/javascript">
    ...
    {       
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrl+"contacts/projectcontacttypes_add/"+id; 
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){       
                if(act=="active"){
                    window.location=baseUrl+"contacts/changestatus/"+id+"/ContactType/1/projectcontacttypes/cngstatus";
                }else{
                    window.location=baseUrl+"contacts/changestatus/"+id+"/ContactType/0/projectcontacttypes/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrl+"contacts/changestatus/"+id+"/ContactType/0/projectcontacttypes/delete";}
            }
        }else{
