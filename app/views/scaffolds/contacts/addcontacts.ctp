<?php
	...
	$backUrl = $base_url.'contacts/contactlist';
...
<?php echo $form->create("contacts", array("action" => "addcontacts",'type' => 'file','enctype'=>'multipart/form-data','name' => 'addcontacts', 'id' => "addcontacts","onsubmit"=>"return validatecontacts('$act');"))?>
