...
<div class="titlCont1">
  <div class="centerPage">
    ...
    <?php echo $form->create("contacts", array("action" => "sa_addcontacts",'type' => 'file','enctype'=>'multipart/form-data','name' => 'addcontacts', 'id' => "addcontacts1","onsubmit"=>"return validatecontacts('$act');"))?> <span class="titlTxt"><?php echo $head; ?> </span>
    <div class="topTabs">
      <ul>
        <li>
