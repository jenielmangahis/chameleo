...
Configure::write('App.base_url', 'http://'.$project['Project']['url'].'/');  
}
...
$url= Configure::read('App.base_url').$project_name;
	...
	// For Home menu link
	 $conditionhome = "Content.project_id='".$project['Project']['id']."' and Content.active_status='1' and Content.delete_status='0' and parent_id ='0' and (Content.internal_alias ='home_page' or Content.internal_alias ='home-page') ".$show_web_only." ".$globalcondition." ".$showcommenttab;
