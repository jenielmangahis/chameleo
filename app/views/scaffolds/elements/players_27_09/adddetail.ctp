...
<span class="titlTxt">
		<?php 
			if($this->data['Company']['id']){
				$act = 'edit';
				echo "".ucfirst($option)." Detail Add/Edit"; 
			}else{
				$act = 'add';
				echo "".ucfirst($option)." Detail Add/Edit"; 
			}	
	...
	<?php echo $form->create("players", array("action" => "adddetail",'type' => 'file','enctype'=>'multipart/form-data','name' => 'adddetail', 'id' => "adddetail","onsubmit"=>"return validatecompany('$act');"));
