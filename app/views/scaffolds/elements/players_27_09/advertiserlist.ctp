        ...
        <div class="tblData">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="trBg">
                    ...
                    <th align="center" valign="middle" style='width:25%;'><span class="right"><?php echo $pagination->sortBy('company_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Advertiser Player Name</th>
					<th align="center" valign="middle" style='width:20%'><span class="right"><?php echo $pagination->sortBy('company_type_id',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Advertiser Type</th>					
                    <th align="center" valign="middle" style='width:14%'><span class="right"><?php echo $pagination->sortBy('phone', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Contact</th>
                    <th align="center" valign="middle" style='width:14%'><span class="right"><?php echo $pagination->sortBy('city', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>City</th>
                    <th align="center" valign="middle" style='width:14%'><span class="right"><?php echo $pagination->sortBy('state', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>State</th>
                ...
                <?php if($companydata){ 
                        ...
                        <tr <?php echo ($i%2 == 0)? 'class="altrow"':'';?> >
                                ...
                                <td align="left" valign="middle" class='newtblbrd'>
									...
									array('controller'=>'players','action'=>'adddetail', 'advertiser', $recid),
									array('escape' => false)
									)
								);
							?>
								...
								<td align="center" valign="middle" class='newtblbrd'>
										...
										if($eachrow['Company']['active_status']=='1'){
											e($html->link(
												...
												array('controller'=>'players','action'=>'changestatus',$recid,$modelname,'0',$redirectionurl,'cngstatus','advertiser'),
												array('escape' => false),
												'Are you sure you want to Deactivate Advertiser ?',
								                false
												)
											);
										} else {
											e($html->link(
												...
												array('controller'=>'players','action'=>'changestatus',$recid,$modelname,'1',$redirectionurl,'cngstatus','advertiser'),
												array('escape' => false),
												'Are you sure you want to Activate Advertiser ?',
								                false
												)
											);
										}			
                        ...
                        <?php } }else{ ?>
                    <tr><td colspan="9" align="center">No Advertiser Found.</td></tr>
                    <?php } ?>
            </table> 
        </div>
        <div>
