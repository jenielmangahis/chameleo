        ...
        <div class="tblData">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="trBg">
                    ...
                    <th align="center" valign="middle" style='width:14%'><span class="right"><?php echo $pagination->sortBy('contact', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Contact</th>
                    ...
                    <th align="center" valign="middle" style='width:54'><span class="right"><?php echo $pagination->sortBy('active', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Status</th>
                </tr>
                <?php if($companydata){ 
                        $i=1;
