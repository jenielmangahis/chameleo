        ...
        <div class="tblData">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="trBg">
                    ...
                    <th align="center" valign="middle" style='width:25%;'><span class="right"><?php echo $pagination->sortBy('company_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Sales Player Name</th>
					<th align="center" valign="middle" style='width:20%'><span class="right"><?php echo $pagination->sortBy('company_type_id',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Sale Type</th>					
                ...
                <?php if($companydata){ 
                        ...
                        <tr <?php echo ($i%2 == 0)? 'class="altrow"':'';?> >
                                ...
                                <td align="left" valign="middle" class='newtblbrd'>
									...
									array('controller'=>'players','action'=>'adddetail', 'sale', $recid),
									array('escape' => false)
									)
								);
							?>
								 ...
								 <td align="center" valign="middle" class='newtblbrd'>
										...
										if($eachrow['Company']['active_status']=='1'){
											e($html->link(
												...
												array('controller'=>'players','action'=>'changestatus',$recid,$modelname,'0',$redirectionurl,'cngstatus','sale'),
												array('escape' => false),
												'Are you sure you want to Deactivate Sale ?',
								                false
												)
											);
										} else {
											e($html->link(
												...
												array('controller'=>'players','action'=>'changestatus',$recid,$modelname,'1',$redirectionurl,'cngstatus','sale'),
												array('escape' => false),
												'Are you sure you want to Activate Sale ?',
								                false
												)
											);
										}			
                        ...
                        <?php } }else{ ?>
                    <tr><td colspan="9" align="center">No Sales Found.</td></tr>
                    <?php } ?>
            </table> 
        </div>
        <div>
