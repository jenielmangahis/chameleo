...
{   
 ...
 function editcontent()
        ...
        if(counter!=1)
        {
                ...
                document.getElementById("linkedit").href=baseUrl+"prospects/taskhistory/"+id;                 
            }
       } 
            ...
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrl+"prospects/changestatus/"+id+"/CommunicationTaskHistory/1/taskhistory/cngstatus";
                                                        }else{
                                                        window.location=baseUrl+"prospects/changestatus/"+id+"/CommunicationTaskHistory/0/taskhistory/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
...
<div class="container">
	<div class="titlCont">
		<div class="myclass">
			...
			<?php echo $form->create("prospects", array("action" => "taskhistory",'name' => 'taskhistory', 'id' => "taskhistory")) ?>
			<script type='text/javascript'>
			...
			<?php    $this->loginarea="prospects";    $this->subtabsel="taskhistory";
