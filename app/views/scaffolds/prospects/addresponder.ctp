...
$lgrt = $session->read('newsortingby');
	...
	$backUrl = $base_url.'prospects/responders';
?>
<?php 
...
<div class="titlCont1"  style="height: 90px;">
	...
	<div class="myclass">
        ...
        echo $form->create("prospects", array("action" => "addresponder".$action,'name' => 'addresponder', 'id' => "addresponder","onsubmit" =>"return validate_responder('$vaction');"));
 ?>
 ...
 <div class="clear"></div>
           <?php 		
   			  $this->loginarea="prospects";    $this->subtabsel="responders";
