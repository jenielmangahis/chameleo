...
$backUrl = $base_url.'prospects/prospectemaillist';
...
var resWindow=  window.open (baseUrl+'prospects/addprospectmailtmp');
//resWindow.focus();
}
</script>
<script type="text/javascript" >
...
<span class="titlTxt">
		<?php 
			if(isset($this->data['Company']['id']) && $this->data['Company']['id']){
				$act = 'edit';
	...
	<?php echo $form->create("prospects", array("action" => "addprospectemail",'type' => 'file','enctype'=>'multipart/form-data','name' => 'addprospectemail', 'id' => "addprospectemail","onsubmit"=>"return validateTaskForm();"));
 ...
 <div style="margin-left:5px;"><?php $this->loginarea="prospects";$this->subtabsel="projectmerchantlist";
       echo $this->renderElement('prospect_email_submenus');  ?></div>
		...
		<tr>
					...
					<tbody>
						<tr>
							<td align="right"><input type="hidden" id="current_domain"
								name="current_domain" value=""> 
								<label class="boldlabel">Task Name <span style="color: red;">*</span>
								</label>
							</td>
			...
			echo $form->select("CommunicationTask.email_template_id",$templatedropdown,$sel_email_temp,array('id' => 'email_template_id','class'=>'multilist','onchange'=>'getEmailTemplate(this.value)'),array('0'=>'--Select--')); ?>
						...
						<tr>
							...
							<?php echo $form->input("CommunicationTask.email_from", array('id' => 'email_from', 'div' => false, 'label' => '','style' =>'width:231px;',"class" => "inpt_txt_fld"));?>
							</span>
							</td>
						</tr>
						...
						<tr>
							...
							<td><span class="txtArea_top"> <span class="txtArea_bot"> <?php echo $form->select("CommunicationTask.category_id",$categorydropdown,$selectedcategory,array('id' => 'category_id','class'=>'multilist'),"---Select---"); ?>
								</span>
							</span></td>
						</tr>
			...
			$('#category_id').live('change', function(){
				$('#sub_category_id').load(baseUrl+'prospects/ajax_get_sub_category/'+$(this).val());
			});
		</script> <span class="txtArea_top"> <span class="txtArea_bot"> 
		<?php echo $form->select("CommunicationTask.sub_category_id", $sub_categories_drpdwn, $selected_sub_category,array('id' => 'sub_category_id','class'=>'multilist'),"---Select---"); ?>
								</span>
							</span></td>
						</tr>
						...
						<tr>
							...
							<?php echo $form->select("CommunicationTask.non_profit_type_id",$nonprofittypedropdown,$sel_nonprofittype,array('id' => 'non_profit_type_id','class'=>'multilist'),"---Select---"); ?>
								</span>
							</span></td>
						</tr>
						...
						<tr>
							...
							<td><span class="txtArea_top"> <span class="txtArea_bot"> <?php echo $form->select("CommunicationTask.offer_id",$offertypedropdown,$sel_offerid,array('id' => 'offer_id','class'=>'multilist'),"---Select---"); ?>
								</span>
							</span></td>
						</tr>
					...
					<tr>
						...
						<tr>
							...
							<td><span class="txtArea_top"> <span class="newtxtArea_bot"> <?php echo $form->select("CommunicationTask.member_country",$countrydropdown,$selectedcountry,array('id' => 'country','class'=>'multilist','onchange'=>'return getstateoptions(this.value,"Company")'),array('254'=>'United States')); ?>
								</span>
							</span></td>
						</tr>
						<tr>
							...
							<td><span class="txtArea_top"> <span class="txtArea_bot"> <span
										id="statediv"> <?php echo $form->select("CommunicationTask.member_state",$statedropdown,$selectedstate,array('id' => 'state','class'=>'multilist'),"---Select---"); ?>
									</span>
								</span>
							</span></td>
						</tr>
...
function validateTaskForm(){
	/*var email_template_type = 	$('#email_template_id').val();*/
