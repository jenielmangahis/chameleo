<!--  [5:25:25 PM] John Wolf: Date Sent, Form Name, Relationship Type, Last Name, First Name, Current Status, Last Edit Date (date Inquiry was last saved).  These are the columns needed, do you require a graphic? --> 
...
{   
 ...
 function editcontent()
        ...
        if(counter!=1)
        {
                ...
                document.getElementById("linkedit").href=baseUrl+"prospects/responderhistory/"+id;                 
            }
       } 
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrl+"prospects/changestatus/"+id+"/CommunicationTaskHistory/1/responderhistory/cngstatus";
                                                        }else{
                                                        window.location=baseUrl+"prospects/changestatus/"+id+"/CommunicationTaskHistory/0/responderhistory/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrl+"prospects/changestatus/"+id+"/CommunicationTaskHistory/0/responderhistory/delete";
                                        }
                        }else{
...
<div align="center" class="slider" id="toppanel">
   ...
   <?php echo $form->create("prospects", array("action" => "responderhistory",'name' => 'responderhistory', 'id' => "responderhistory")) ?>
                <script type='text/javascript'>
...
<!--li><a href="javascript:void(0)" onclick="editcontent();" id="linkedit"><span>Edit</span></a></li-->
               ...
               <?php    $this->loginarea="prospects";    $this->subtabsel="responder_history";
...
<div id="blck"> 
    ...
    z-index: 11;" /></a>
               ...
               <div class="new_filter" >
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>commtaskhistorylist')" id="locaa"></span>
        ...
        <?php
                if($responderhistorydata){
                        foreach($responderhistorydata as $eachrow){
        ...
        <?php } } else{ ?>
        <tr><td colspan="9" align="center">No Responders History Found.</td></tr>
        <?php } ?>
        </table>
      ...
      <div class="gryBot"><?php if($responderhistorydata) { echo $this->renderElement('newpagination'); } ?>
      </div>
