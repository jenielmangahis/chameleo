...
<script type="text/javascript">
    ...
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrl+"prospects/addprospectemail/edit/"+id; 
...
<div class="container">
         <div class="titlCont">
		  <div class="centerPage" >
			...
			<?php } ?>
            <span class="titlTxt">Active Task</span>
            ...
            <div class="topTabs">
                <ul class="dropdown">
					...
					<?php
							e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'prospects','action'=>'addprospectemail'),
								array('escape' => false)
								)
							);
						?>
	        ...
	        <?php
			 		$this->loginarea="prospects";    $this->subtabsel="activetask";
               ...
               <td align="center" class='newtblbrd'><a><span><input type="checkbox"  class="checkid" name="checkid[]" value="<?php echo $recid; ?>" /></a></span></td>
				...
				<?php
						e($html->link(
							...
							array('controller'=>'prospects','action'=>'addprospectemail','edit',$recid),
							array('escape' => false)
							)
						);
				?>
				...
				?>
                        ...
                        <?php } }else{ ?>
                    <tr><td colspan="9" align="center">No Active Task Found.</td></tr>
                    <?php } ?>
            </table> 
        </div>
        <div>
