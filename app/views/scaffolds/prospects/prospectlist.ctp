...
<script type="text/javascript">
 ...
 <?php if($ct_id =='1'){
		 $subtabsel = "projectvendors";
		 $title_Val = 'Vendor';
		}else if($ct_id =='3'){
			$title_Val = 'Sales';
			$subtabsel = "projectsales";
		}
		else if($ct_id =='5'){
			$title_Val = 'Advertiser';
			$subtabsel = "projectcAdvertiser";
		}
		else if($ct_id =='6'){
			$title_Val = 'Other';
			$subtabsel = "projectother";
		}
?>		
...
<div class="container">
         <div class="titlCont">
		  <div class="centerPage" >
            ...
            <?php echo $form->create("prospects", array("url" => "prospectlist/$title_Val",'name' => 'prospectlist', 'id' => "prospectlist")) ?>      
			<?php echo $form->hidden("params", array('id' => 'params','value'=>"$title_Val"));?>
            <script type='text/javascript'>
			...
			<?php if($usertype==trim("admin")){ ?>
				...
				<span class="titlTxt"><?php echo ucfirst($str_type) ?></span>
			<?php }else{ ?> <span class="titlTxt"><?php echo ucfirst($str_type) ?></span><?php } ?>
            ...
            <div class="topTabs">
                <ul class="dropdown">
					...
					<?php
							e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'prospects','action'=>'addprospect',$title_Val),
								array('escape' => false)
								)
							);
						?>
        ...
        <div class="tblData">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="trBg">
                    ...
                    <th align="center" valign="middle" style='width:25%;'><span class="right"><?php echo $pagination->sortBy('company_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span><?php echo $title_Val ?> Prospect Name</th>
					<th align="center" valign="middle" style='width:15%'><span class="right"><?php echo $pagination->sortBy(' 	company_type_category_id',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),CompanyType,null,' ',' '); ?></span><?php echo $title_Val ?> Type</th>					
                ...
                <?php if($companydata){ 
						...
						//echo '<pre>';print_r($eachrow);
                            ...
                            $modelname = "Company";
                            $redirectionurl = "prospectlist/$title_Val";
							
                            $company_type_cat_id = $eachrow['CompanyType']['company_type_category_id'];
							
							
						
							$company_category_data =  $common->getCompanyCategoryName($company_type_cat_id);
						$company_type_cat_id = $company_category_data['0']['CompanyTypeCategory']['company_type_category_name'];
                        ...
                        <?php if($i%2 == 0) { ?>
                            <tr class='altrow'>	
                                ...
                                <td align="left" valign="middle" class='newtblbrd'>
									...
									array('controller'=>'prospects','action'=>'addprospect',$title_Val,$recid),
									array('escape' => false)
									)
								);
							?>
							 ...
							 <td align="left" valign="middle" class='newtblbrd'>
									...
									e($html->link(
									$html->tag('span', $company_type_cat_id),
									array('controller'=>'prospects','action'=>'addprospect',$title_Val,$recid),
									array('escape' => false)
									)
								);
