        ...
        <div style="height: 30px; clear: both;">
            <ul class="topTabs2">
                <!--<li><a href="/admins/eventcreate/<?php // echo $event_id; ?>"><span>Edit Event</span></a></li>-->
                  <li>
						<!--<a href="/admins/rsvp/<?php echo $rec_event_id; if($hide_menu==1) echo "/pastevent";?>" class="tabSelt"><span>RSVP</span></a>-->
						<?php
								e($html->link(
									$html->tag('span', 'RSVP'),
...
<div class="midCont">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2"><input type="button" value="Csv file download" label="" onclick="jjavascript:(window.location='/admins/downloadrsvp/<?php echo $rec_event_id;?>')" > </span>
    ...
    <div class="tblData">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg">
                ...
                <th align="center" valign="middle" width="10%"><span class="right"><?php echo $pagination->sortBy('active_status', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Donator Level</th>
                <th align="center" valign="middle" width="10%"><span class="right"><?php echo $pagination->sortBy('active_status', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>RSVP Date</th>
                ...
                <th align="center" valign="middle" width="7%"><span class="right"><?php echo $pagination->sortBy('active_status', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>RSVP</th>
            ...
            <?php if($eventdata){ 
                    ...
                    foreach($eventdata as $eachrow){
                        ...
                        $event_name = $eachrow['RecurrringEvent']['event_title'];
                        ...
                        $starttime = $starttime. date('g:i a', strtotime($eachrow['RecurrringEvent']['starttime'])); 
