...
?>
			...
			<!--<li><a href="/admins/rsvp/<?php // echo $rec_event_id; ?>"><span>RSVP</span></a></li>
                  <?php
     if($waiting_list==1)  
                   {
                    ?>
                  <li><a href="/admins/waitlist/<?php // echo $rec_event_id; ?>"><span>Wait List</span></a></li>
                  <?php
                   }
                   ?>
                   <li><a href="/admins/send_invite/<?php // echo $rec_event_id; ?>" ><span>Send Invite</span></a></li>
                   <li><a href="/admins/event_task/<?php // echo $rec_event_id; ?>" class="tabSelt"><span>Event Task</span></a></li>
                   <li><a href="/admins/eventinvitationhistory/<?php // echo $rec_event_id; ?>"><span>Invites</span></a></li>-->
                    </ul>
                </div>
            </div>  
            <div class="clear"></div>
                                    ...
                                    <td>
                                     <span class="txtArea_top">
                                        <span class="txtArea_bot">
                                          <span id="statediv"> 
                                    <?php echo $form->select("CommunicationTask.rec_event_id",$eventdropdown,$sel_event,array('id' => 'event_id','class'=>'multilist'),"---Select---"); ?></span>
                                    </span>
                                    </span>  
                                    </td>
                                </tr>
                    ...
                    <td width="45%" valign="top">
                        ...
                        <table cellspacing="10" cellpadding="0" align="center" width="100%">
                                ...
                                <tr>
                                    ...
                                    <a href="/admins/changestatus/<?php echo $this->data['CommunicationTask']['id'].'/CommunicationTask/1/event_task'?>"><img src="/img/<?php echo $project_name?>/deactive.gif" alt=""   /></a>
                                     <?php }else{ ?>
                                      <a href="/admins/changestatus/<?php echo $this->data['CommunicationTask']['id'].'/CommunicationTask/0/event_task'?>"><img src="/img/<?php echo $project_name?>/active.gif" alt=""  /></a>
                                    <?php } ?>
                                    <?php } ?>
                                    </td>
                                </tr>
    ...
    $(function() {
       ...
       $( "#runreport" ).click(function() {  // runTaskReport();
            ...
            $.ajax({
                            ...
                            url: 'http://'+current_domain+'/admins/commtask_get_report_list_by_ajax/',
                            cache: false,
         ...
         */
         function addEmailTempforTask() {   
             ...
             var resWindow=  window.open ('/admins/addmailtemplate/popup', 'AddTemp','location=1,status=1,scrollbars=1, width=950,height=650');
             resWindow.focus();
           }
         ...
         */
         function addCommentTypeforTask() {
             ...
             var resWindow=  window.open ('/admins/addcommenttype/popup', 'AddCommentType','location=1,status=1,scrollbars=1, width=950,height=650');
             resWindow.focus();
           }
        ...
        */
        function getcommenttypesbyajax(projectid,eleid, selectedid) {    
               ...
               jQuery.ajax({
                     type: "GET",
                     url: '/admins/getcommenttypesbyajax/'+projectid+'/'+selectedid,
                     cache: false,
