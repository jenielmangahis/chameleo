...
<span class="titlTxt">Social Networks </span>
	<div class="topTabs">
	<ul>
	...
	<div class="newscltab" id="newscltab">
  ...
  <?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
		...
		<tr class="trBg">
		<th class="" style='width:65px;' align="center" valign="middle">
		    <?php
			e(
...
echo "&nbsp;&nbsp;&nbsp;&nbsp;";
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_link", array('id' => "title_link", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></span>
		</td>
		<td class='brdtab3'> <span class="intpSpan1"><?php echo $form->text("address_link", array('id' => "address_link", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?>
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_face", array('id' => "title_face", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></span>
		</td>
		
		<td class='brdtab3'> <span class="intpSpan1"><?php echo $form->text("address_face", array('id' => "address_face", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?></span>
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_twit", array('id' => "title_twit", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></span>
		</td>

		<td class='brdtab3'> <span class="intpSpan1"><?php echo $form->text("address_twit", array('id' => "address_twit", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?></span>
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_don", array('id' => "title_don", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></span>
		</td>
		
		<td class='brdtab3'> <span class="intpSpan1"><?php echo $form->text("address_don", array('id' => "address_don", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?></span>
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_don1", array('id' => "title_don1", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></div>
		</td>
		
		<td class='brdtab3'> <span class="intpSpan1"><?php echo $form->text("address_don1", array('id' => "address_don1", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?></span>
		...
		<td class='brdtab' align=""><span class="intpSpan1"><?php echo $form->input("title_don2", array('id' => "title_don2", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></span>
		</td>
		
		<td class='brdtab3'> <span class="intpSpan1"><?php echo $form->text("address_don2", array('id' => "address_don2", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?></span>
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_don3", array('id' => "title_don3", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?>
		</td>
		
		<td class='brdtab3'> <span class="intpSpan1"><?php echo $form->text("address_don3", array('id' => "address_don3", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?>
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_don4", array('id' => "title_don4", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></span>
		</td>
		
		<td class='brdtab3'><span class="intpSpan1"> <?php echo $form->text("address_don4", array('id' => "address_don4", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?></span>
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_don5", array('id' => "title_don5", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></span>
		</td>
		
		<td class='brdtab3'> <span class="intpSpan1"><?php echo $form->text("address_don5", array('id' => "address_don", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?></span>
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_don6", array('id' => "title_don6", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></span>
		</td>
		
		<td class='brdtab3'> <span class="intpSpan1"><?php echo $form->text("address_don6", array('id' => "address_don6", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?></span>
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_don7", array('id' => "title_don7", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></span>
		</td>
		
		<td class='brdtab3'><span class="intpSpan1"> <?php echo $form->text("address_don7", array('id' => "address_don", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?></span>
		...
		<td class='brdtab'><span class="intpSpan1"><?php echo $form->input("title_don8", array('id' => "title_don8", 'div' => false, 'label' => '',"class" => "inpt_newtxt_fld","maxlength" => "250"));?></span>
		</td>
		
		<td class='brdtab3'><span class="intpSpan1"> <?php echo $form->text("address_don8", array('id' => "address_don8", 'div' => false, 'label' => '',"class" => "inpt_txt_flds"));?></span>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <span class="socialtxttop"><span class="socialSpan"><textarea id="codeval" style="background: none repeat scroll 0% 0% transparent; width: 500px;" class="socialtxtArea1" cols="2000" rows="5"></textarea></span></span></div></td>
		...
		<li><span>&nbsp;</span></li>
            <li><button type="button" value="Copy" class="button" name="copyb" onclick="this.form.codeval.focus();this.form.codeval.select();"><span>Copy</span></button></li>
            </ul>
            </div>
              </td>
        </tr>
