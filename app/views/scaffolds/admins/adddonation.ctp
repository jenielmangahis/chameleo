...
<?php $lgrt = $session->read('newsortingby');
	...
	$backUrl = $base_url_admin.'donationlist';
?>
<div class="titlCont1"><div style="width:960px;margin:0 auto">
<?php echo $form->create("Admins", array("action" => "adddonation",'name' => 'adddonation', 'id' => "adddonation",'onsubmit' => 'return validateDonationLevel("add");'));
