...
<div class="container">
       <div class="titlCont"><div class="centerPage">
            ...
            <?php echo $form->create("Admin", array("action" => "top_points",'name' => 'top_points', 'id' => "top_points")) ?>
            <script type='text/javascript'>
            ...
            <span class="titlTxt">   Top Points  </span>
            ...
            <!--<div class="topTabs">
              ...
              <?php    $this->loginarea="admins";    $this->subtabsel="top_points";
...
<div class="midCont" id="newhldtab">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2">
                <input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrlAdmin+'top_points')" id="locaa">&nbsp;&nbsp;  
    ...
    <div class="tblData">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <?php if($memberlist){
                    ...
                    <?php } }else{ ?>
                <tr><td colspan="9" align="center">No top point member(s) found.</td></tr>
                <?php  } ?>
    ...
    <div class="gryBot"><?php if(isset($top_points_arr)) { echo $this->renderElement('newpagination'); } ?>
    </div>
    <div class="clear"></div>
