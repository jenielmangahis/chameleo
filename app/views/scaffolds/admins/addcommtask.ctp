<?php
	...
	$backUrl = $base_url_admin.'addcommtask';
?>
<?php
...
<script type="text/javascript">
 ...
 echo $form->create("Admins", array("action" => "addcommtask",'name' => 'addcommtask', 'id' => "addcommtask",'onsubmit'=>'return validatecommtask();'));
 ...
 // $this->CommunicationTask::FIELD_TASK_ID;
                                ...
                                <tr>
                                    ...
                                    <td>
                                          ...
                                          <span class="txtArea_bot">
                                            <?php 
											echo $form->select("CommunicationTask.email_template_id",(isset($templatedropdown))?$templatedropdown:'',$sel_email_temp,array('id' => 'email_template_id','class'=>'multilist','onchange'=>'getEmailTemplate(this.value)'),array('0'=>'--Select--')); ?>
                                          </span>
                                          </span>
                    ...
                    <td width="45%" valign="top">
                        <table cellspacing="10" cellpadding="0" align="center" width="100%">
                              ...
                              <?php /*if(isset($eachrow['CommunicationTask']['active_status'])=='0'){
								...
								array('controller'=>'admins','action'=>'changestatus','0','cngstatus'),
								array('escape' => false)
								)
							);
							}else{
									e($html->link(
											...
											array('controller'=>'admins','action'=>'changestatus','1','cngstatus'),
											array('escape' => false)
											)
										);
							}	 */
       ...
       $( "#runreport" ).click(function() {  // runTaskReport();
         ...
         */
         function addEmailTempforTask() {   
             ...
             var resWindow=  window.open (baseUrlAdmin+'addmailtemplate/popup');
             resWindow.focus();
           }
