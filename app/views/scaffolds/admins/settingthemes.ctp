...
<div class="titlCont">
  <div class="myclass">
    ...
    <?php echo $form->create("Admins", array("action" => "settingthemes",'type' => 'file','enctype'=>'multipart/form-data','name' => 'settingthemes', 'id' => "settingthemes")); ?> <span class="titlTxt1"><?php echo $project_name;  ?>:&nbsp;</span> <span class="titlTxt"> Themes </span>
    <div class="topTabs">
      <ul>
        <li>
          ...
          <table class="themetbl2" width="100%" cellpadding="0" cellspacing="8">
            <tr>
              <td class="themetbl2_td1">
                <fieldset>
                  <legend>Header & Footer Color</legend>
                  <ul class="form-style">
                    <li>
              ...
              <td class="themetbl3_td2" >
                <fieldset>
                  ...
                  <li>
                    ...
                    <li>
                    <label  class="boldlabel">Menu Hover Color</label>
...
<script type="text/javascript" language="javascript">
	...
	function getsource1()
    {
        var code="<iframe width='auto' style='height: 100%; border:none' src='http://<?php echo $_SERVER['HTTP_HOST'];?>/companies/iframeshowcoins/<?php echo $project_id;?>/<?php echo $project_name;?>'></iframe>";
        document.getElementById("codeval1").value=code;
    }
	
    function getsource2()
    {
        var code="<iframe width='170px' style='height: 55px; border:none' src='http://<?php echo $_SERVER['HTTP_HOST'];?>/companies/iframeregisterbtn/<?php echo $project_id;?>/<?php echo $project_name;?>'></iframe>";
        document.getElementById("codeval2").value=code;
    }
    function getsource3()
    {
        var code="<iframe width='170px' style='height: 55px; border:none' src='http://<?php echo $_SERVER['HTTP_HOST'];?>/companies/iframecommentbtn/<?php echo $project_id;?>/<?php echo $project_name;?>'></iframe>";
