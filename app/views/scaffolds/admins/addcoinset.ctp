<?php
	...
	$backUrl = $base_url_admin.'coinsetlist';
...
<div class="rightpanel" style="width:960px; margin:0 auto">
        ...
        <div>
            ...
            <table width="425px" class="left">
                ...
                <tr class="upload_content">
                    ...
                    <tr>
                        <td align="right" style="padding-top: 0px;"><label class="boldlabel">Order Date <span style="color: red;">*</span></label></td>
                    ...
                    <tr>
                        ...
                        <td  style="padding-left: 0px; padding-top: 12px;">
                            ...
                            <span class="txtArea_bot">
                                <?php echo $form->select("Coinset.ship_type_id",$shippingdropdown,null,array('id' => 'ship_type_id','class'=>'multilist',"onchange"=>"getshippingdays(this.value);"),"---Select---"); ?>
                            </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
    ...
    <div class="frmbox mgrt115">
        <table cellspacing="0" cellpadding="0" align="center" align="center" width="500px" class="left">
            ...
            <tr>
                <td align="right" style="padding-top: 0px;"><label class="boldlabel">Product Type <span style="color: red;">*</span></label></td>
                <td  style="padding-left: 31px; padding-top: 12px;">
                    <span class="txtArea_top"><span class="txtArea_bot">
                            <?php echo $form->select("Coinset.price_type_options_id",$product_pricing,null,array('id' => 'price_type_options_id',"class"=>"multilist",'onchange'=>'getproducttypedays(this.value);' ),"---Select---"); ?>
        ...
        <table cellspacing="5" cellpadding="0" align="center" align="center" width="500px" class="left" style="margin-top: 30px; margin-bottom: 30px;margin-left: 35px">
            ...
            <tr>
                <td colspan="5" valign="top">Additional Options</td>
            </tr>
