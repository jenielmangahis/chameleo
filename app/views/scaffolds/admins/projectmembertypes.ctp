<script type="text/javascript">
    ...
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrlAdmin+"projectmembertypes_add/"+id; 
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){	
                if(act=="active"){
                    window.location=baseUrlAdmin+"changestatus/"+id+"/MemberType/1/projectmembertypes/cngstatus";
                }else{
                    window.location=baseUrlAdmin+"changestatus/"+id+"/MemberType/0/projectmembertypes/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrlAdmin+"changestatus/"+id+"/MemberType/0/projectmembertypes/delete";
            }
        }else{
...
<div class="container">
       <div class="titlCont"><div style="width:960px; margin:0 auto;">
            ...
            <?php echo $form->create("Admins", array("action" => "projectmembertypes",'name' => 'projectmembertypes', 'id' => "projectmembertypes")) ?>
            <script type='text/javascript'>
            ...
            <div class="topTabs">
                <ul class="dropdown">
                    <!--    <li><a href="/admins/projectmembertypes_add"><span>New</span></a></li>  -->
            ...
            <?php    $this->loginarea="admins";    $this->subtabsel="projectmembertypes";
...
<div class="midCont" id="newhldtab">
    ...
    <div>
      ...
      ?> 
            ...
            <span class="srchBg2">
                <input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrlAdmin+'projectmembertypes')" id="locaa">&nbsp;&nbsp;  
           </span>
</div>
        </div>
    ...
    <div class="tblData">
        ...
        <th align="center" valign="middle" style="width:3%"><input type="checkbox" id="checkall" name="checkall" value=""></th>
            <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('member_type', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
			 ?></span>Member Type</th>
            <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('is_coinholder', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
			 ?></span>Coin Holder</th>
			        <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('note', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
			 ?></span>Google Pin Color</th>
            <th align="center" valign="middle" style="width:40%"><span class="right"><?php echo $pagination->sortBy('pincolor', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
			 ?></span>Note</th>
             ...
             <td align="left" class='newtblbrd' valign="middle">
				<?php
					e($html->link(
						...
						array('controller'=>'admins','action'=>'projectmembertypes_add',$recid),
						array('escape' => false)
						)
					);
				?>
