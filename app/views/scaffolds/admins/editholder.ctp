                            ...
                            <table  width="100%" cellspacing="10" cellpadding="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="btnLft"><input type="button" class="btnRht" value="View" name="view" ONCLICK="javascript:(window.location='/admins/registercoinlist')" /></span><span style="display:inline-block;width:8px"></span><span class="btnLft"><input type="button"  class="btnRht" value="Add" name="Add" ONCLICK="javascript:(window.location='/admins/regcoinset/<?php echo $coinHolder;?>')" /></span>
                                    </td>
                                </tr>
