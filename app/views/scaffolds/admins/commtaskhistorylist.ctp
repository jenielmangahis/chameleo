    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrlAdmin+"changestatus/"+id+"/CommunicationTaskHistory/1/commtaskhistorylist/cngstatus";
                                                        }else{
                                                        window.location=baseUrlAdmin+"changestatus/"+id+"/CommunicationTaskHistory/0/commtaskhistorylist/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrlAdmin+"changestatus/"+id+"/CommunicationTaskHistory/0/commtaskhistorylist/delete";
                                        }
                        }else{
...
<!--li><a href="javascript:void(0)" onclick="editcontent();" id="linkedit"><span>Edit</span></a></li-->
               ...
               <?php    $this->loginarea="admins";    $this->subtabsel="commtaskhistorylist";
...
<div id="blck"> 
    ...
    z-index: 11;" /></a>
               ...
               <div class="new_filter">
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>commtaskhistorylist')" id="locaa"></span></div>
	...
	<?php if($i%2 == 0) { ?>
        <tr class='altrow'>    
                ...
                <td align="left" valign="middle" class='newtblbrd'><a href="javascript:void(0);" class="showSentHistory" id="date_<?php echo $recid;?>_<?php echo $taskid;?>_<?php echo $projectid;?>" ><span><?php echo $task_sent_date; ?><a></span></td>   
                <td align="left" valign="middle" class='newtblbrd'><a href="javascript:void(0);" class="showSentHistory" id="emailtemp_<?php echo $recid;?>_<?php echo $taskid;?>_<?php echo $projectid;?>" ><span><?php echo $task_name; ?><a></span></td>              
                <td align="left" valign="middle" class='newtblbrd'><a href="javascript:void(0);" class="showSentHistory" id="recur_<?php echo $recid;?>_<?php echo $taskid;?>_<?php echo $projectid;?>" ><span><?php echo $task_email_tempname; ?><a></span></td>              
                <td align="left" valign="middle" class='newtblbrd'><a href="javascript:void(0);" class="showSentHistory" id="sentcnt_<?php echo $recid;?>_<?php echo $taskid;?>_<?php echo $projectid;?>" ><span><?php echo $task_recur_pattern.": ".$recurOn; ?><a></span></td>              
                <td align="center" valign="middle" align="center" class='newtblbrd'><a href="javascript:void(0);" class="showSentHistory" id="taskname_<?php echo $recid;?>_<?php echo $taskid;?>_<?php echo $projectid;?>" ><span><?php echo $task_sent_count; ?><a></span></td>              
               <!--  <td align="center" valign="middle" class='newtblbrd'><a><span>< ?php if($eachrow['CommunicationTaskHistory']['active_status']=='1'){ ?><a href="/admins/changestatus/< ?php echo $recid.'/'.$modelname.'/'.'0/'.$redirectionurl.'/cngstatus'?>"><img src="/img/< ?php echo $project_name?>/active.gif" alt="" title="Click here to deactivate < ?php echo $coinsetname; ?>" /></a>< ?php }else{ ?><a href="/admins/changestatus/< ?php echo $recid.'/'.$modelname.'/'.'1/'.$redirectionurl?>"><img src="/img/< ?php echo $project_name?>/deactive.gif" alt=""  title="Click here to activate < ?php echo $coinsetname; ?>" /></a>< ?php } ?></td>-->
	...
	<tr>    
                ...
                <td align="left" valign="middle" class='newtblbrd'><a href="javascript:void(0);" class="showSentHistory" id="date_<?php echo $recid;?>_<?php echo $taskid;?>_<?php echo $projectid;?>" ><span><?php echo $task_sent_date; ?><a></span></td>              
                <td align="left" valign="middle"><a href="javascript:void(0);" class="showSentHistory" id="taskname_<?php echo $recid;?>_<?php echo $taskid;?>_<?php echo $projectid;?>" ><span><?php echo $task_name; ?><a></span></td>              
                <td align="left" valign="middle" class='newtblbrd'><a href="javascript:void(0);" class="showSentHistory" id="emailtemp_<?php echo $recid;?>_<?php echo $taskid;?>_<?php echo $projectid;?>" ><span><?php echo $task_email_tempname; ?><a></span></td>              
                <td align="left" valign="middle" class='newtblbrd'><a href="javascript:void(0);" class="showSentHistory" id="recur_<?php echo $recid;?>_<?php echo $taskid;?>_<?php echo $projectid;?>" ><span><?php echo $task_recur_pattern.": ".$recurOn;  ?><a></span></td>              
                <td align="center" valign="middle" align="center" class='newtblbrd'><a href="javascript:void(0);" class="showSentHistory" id="sentcnt_<?php echo $recid;?>_<?php echo $taskid;?>_<?php echo $projectid;?>" ><span><?php echo $task_sent_count; ?><a></span></td>              
               <!--  <td align="center" valign="middle" class='newtblbrd'><a><span>< ?php if($eachrow['CommunicationTaskHistory']['active_status']=='1'){ ?><a href="/admins/changestatus/< ?php echo $recid.'/'.$modelname.'/'.'0/'.$redirectionurl.'/cngstatus'?>"><img src="/img/< ?php echo $project_name?>/active.gif" alt="" title="Click here to deactivate < ?php echo $coinsetname; ?>" /></a>< ?php }else{ ?><a href="/admins/changestatus/< ?php echo $recid.'/'.$modelname.'/'.'1/'.$redirectionurl?>"><img src="/img/< ?php echo $project_name?>/deactive.gif" alt=""  title="Click here to activate < ?php echo $coinsetname; ?>" /></a>< ?php } ?></td>-->
