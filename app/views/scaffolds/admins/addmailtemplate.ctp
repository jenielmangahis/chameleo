<?php
  ...
  /*  $server_path=$_SERVER['REQUEST_URI'];
    ...
    if($server_para[2]==0)
    {
        echo" <script type='text/javascript'> window.onunload = function (e) { opener.update_email_page_list(); window.close(); }; </script>";
    }*/
?>

<?php $lgrt = $session->read('newsortingby');
$base_url_admin = Configure::read('App.base_url_admin');
$backUrl = $base_url_admin.'eventautoresponders';
