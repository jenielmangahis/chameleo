...
<div class="titlCont1"><div class="centerPage">
       ...
       <div class="topTabs">
            <ul>
                ...
                <li><button type="button" id="saveForm" class="button"  ONCLICK="javascript:(window.location='<?php echo $base_url_admin ?>formstatustypelist')"><span> Cancel</span></button></li>
            </ul>
        </div>
    </div></div>
