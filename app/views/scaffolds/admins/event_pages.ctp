...
$base_url = Configure::read('App.base_url');
 ...
 //   $server_para=explode('/',$server_path);
    ...
    $server_para3 = 0;
	if(isset($server_para[3]) && !empty($server_para[3]))
	$server_para3 = $server_para[3];
?>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){       
                if(act=="active"){
                    window.location=baseUrlAdmin+"changestatus/"+id+"/RecurringEvent/1/event_pages/cngstatus/0/<?php echo $server_para3;?>";
                }else{
                    window.location=baseUrlAdmin+"changestatus/"+id+"/RecurringEvent/0/event_pages/cngstatus/0/<?php echo $server_para3;?>";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrlAdmin+"changestatus/"+id+"/RecurringEvent/0/event_pages/delete/0/<?php echo $server_para3;?>";
            }
        }else{
...
<div class="midCont">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>event_pages/<?php echo $server_para['0']?>')" id="locaa"></span></div>
