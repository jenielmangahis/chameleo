...
{   
        ...
        if(counter!=1)
        {
                ...
                document.getElementById("linkedit").href=baseUrlAdmin+"actionreply/"+id; 
...
{   
    ...
    $('.checkid').each(function(){       
        ...
        if(id !=""){
                        if(op=="change"){       
                                if(act=="active"){
                                        window.location=baseUrlAdmin+"changestatus/"+id+"/Subcomment/1/commentreplylist/cngstatus";
                                        }else{
                                        window.location=baseUrlAdmin+"changestatus/"+id+"/Subcomment/0/commentreplylist/cngstatus";
                                        }
                        }
                        if(op=="del"){
			...
			if(confirm("Are You Sure to delete the item"))
                        window.location=baseUrlAdmin+"changestatus/"+id+"/Subcomment/0/commentreplylist/delete";
                        }
        }else{
...
<?php $pagination->setPaging($paging); ?> 
 ...
 <div class="titlCont"><div class="centerPage">
	...
	<?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrlAdmin+'commentreplylist')" id="locaa"></span></div>
...
<?php $i=1; ?>  
        ...
        <th align="center" valign="middle" style="width:28%"><span class="right"><?php echo $pagination->sortBy('comment', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Reply</th>
        <th align="center" valign="middle" style="width:30%" ><span class="right"><?php echo $pagination->sortBy('comment', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Comment</th>
        <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('holder_id', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Screen Name</th>     
...
<?php if($i%2 == 0) { ?>
        ...
        <tr class='altrow'>    
				...
				e($html->link(
					...
					array('controller'=>'admins','action'=>'actionreply',$recid),
					array('escape' => false)
					)
				);
			?>
...
<script type="text/javascript">
	...
	{		
	document.getElementById("cmttab").className = "newmidCont";
	}	
</script>
