        ...
        <div style="height: 30px; clear: both;">
            <ul class="topTabs2">
                <!--<li><a href="/admins/eventcreate/<?php // echo $event_id; ?>"><span>Edit Event</span></a></li>-->
                  <li><a href="/admins/rsvp/<?php echo $rec_event_id; if($hide_menu==1) echo "/pastevent";?>" ><span>RSVP</span></a></li>
                  <li><a href="/admins/waitlist/<?php echo $rec_event_id; if($hide_menu==1) echo "/pastevent";?>" class="tabSelt"><span>Wait List</span></a></li>
                  <?php
                   if($hide_menu==0)
                   {
                   ?>
                  <li><a href="/admins/send_invite/<?php // echo $rec_event_id; ?>"><span>Send Invite</span></a></li>
                   <li><a href="/admins/eventtasklist/<?php echo $rec_event_id; ?>"><span>Event Task</span></a></li>
                   <?php
                   }
                    ?>
                   <li><a href="/admins/eventinvitationhistory/<?php echo $rec_event_id; if($hide_menu==1) echo "/pastevent";?>"><span>Invites</span></a></li>
                   <?php
                   if($hide_menu==0)
                   {
                   ?>
                   <li><a href="/admins/event_donations/<?php echo $rec_event_id; ?>"><span>Donations</span></a></li>
                   <li><a href="/admins/event_volunteers/<?php echo $rec_event_id; ?>"><span>Volunteers</span></a></li>
                   <?php
                   }
                    ?>
            </ul>
