<?php $lgrt = $session->read('newsortingby');
	...
	$backUrl = $base_url_admin.'projectdonatelevels';
?>
<div class="titlCont1"><div style="width:960px;margin:0 auto">
<?php echo $form->create("Admins", array("action" => "projectdonatelevels_add",'name' => 'projectdonatelevels_add', 'id' => "projectdonatelevels_add",'onsubmit' => 'return validateDonationLevel("add");'));
