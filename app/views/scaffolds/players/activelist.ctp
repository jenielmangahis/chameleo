...
<script type="text/javascript">
    ...
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrl+"players/addtask/edit/"+id; 
        ...
        if(id !=""){
            ...
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrl+"players/changestatus/"+id+"/CommunicationTask/0/activelist/delete";
            }
        }else{
...
<?php if($usertype==trim("admin")){ ?>
    ...
    <div class="midCont" id="cmplisttab">
        ...
        <div class="tblData">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="trBg">
					...
					<th align="center" valign="middle" style='width:15%'><span class="right"><?php echo $pagination->sortBy('email_template_id',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Releated Template</th>					           
        ...
        <tr  <?php if($i%2 == 0) echo "class='altrow'"; else echo ""; ?> >    
               ...
               <td align="center" class='newtblbrd'><a><span><input type="checkbox"  class="checkid" name="checkid[]" value="<?php echo $recid; ?>" /></a></span></td>
				...
				<?php
						e($html->link(
							...
							array('controller'=>'players','action'=>'addtask','edit',$recid),
							array('escape' => false)
							)
						);
				?>
               ...
               <td align="center" valign="middle" class='newtblbrd'>
				...
				?>
                        ...
                        <?php } }else{ ?>
                    <tr><td colspan="9" align="center">No Active List Found.</td></tr>
                    <?php } ?>
            </table> 
        </div>
        <div>
