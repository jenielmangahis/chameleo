...
$backUrl = $base_url.'players/taskhistory';
...
{   
 ...
 function editcontent()
        ...
        if(counter!=1)
        {
                ...
                document.getElementById("linkedit").href=baseUrl+"players/responderhistory/"+id;                 
            }
       } 
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrl+"players/changestatus/"+id+"/CommunicationTaskHistory/1/responderhistory/cngstatus";
                                                        }else{
                                                        window.location=baseUrl+"players/changestatus/"+id+"/CommunicationTaskHistory/0/responderhistory/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrl+"players/changestatus/"+id+"/CommunicationTaskHistory/0/responderhistory/delete";
                                        }
                        }else{
