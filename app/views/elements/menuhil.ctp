...
<?php } else if($actions=="projectlist" || $actions== "addproject"|| $actions== "editproject" || $actions== "projectlist_by_product" || $actions== "ownerlist" || $actions== "billing_status_list" || $actions== "user_agreehistory") { ?>
...
<?php }else if ($actions=="sa_contactlist" || $actions== "sa_companylist"){ ?>
...
<?php }else if ($actions== "user_agreement_list_by_project" || $actions== "user_agreement_list" || $actions== "user_agreehistory" || $actions== "spam_policy" || $actions== "terms_by_admin"||$actions== "border_footer_list"){ ?>

<script type="text/javascript">
$(document).ready(function() {
$('#LegalMnu').removeClass("butBg");
$('#LegalMnu').addClass("butBgSelt");
}); 
</script> 
<?php }else if($actions=="super_admin_changepassword" || $actions=="help_list" ||  $actions== "mail_footer" || $actions== "getstarted"){ ?>
<script type="text/javascript">
$(document).ready(function() {
...
<?php }else
if( $actions=="loginterms" || $actions=="settings" || $actions=="coinsetlist"||  $actions=="addcoinset"||  $actions=="editcoinset" || $actions=="points" || $actions=="fbfeeds"  || $actions=="projectshoppingcart" || $actions=="getstart" || $actions=="change_password" ){ ?>
...
<?php  } else if( $actions== "supermailtemplatelist" || $actions== "mailtask_list" ){ ?>
	<script type="text/javascript">
		$(document).ready(function() {
