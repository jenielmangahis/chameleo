    ...
    function saveEmailTask($taskArrary, $projectid, $is_temp=0){
				    ...
				    if(!isset($taskArrary['id']) || $taskArrary['id']==""){
                	 ...
                	 $taskArrary['project_id'] = $projectid;
               		if($taskArrary['company_type']!="" || $taskArrary['contact_type']!=""){
                    // all USer related parameters should be null
					$taskArrary['subscription_type']="";
                    $taskArrary['member_type']="";
                    $taskArrary['member_gender']="";
                    ...
                    $taskArrary['member_days_since']="";
                    $taskArrary['member_country']="";
                    $taskArrary['member_state']="";
                    $taskArrary['member_zipcode_from']="";
                    $taskArrary['member_zipcode_to']="";
                    $taskArrary['event_id']="";
                    $taskArrary['event_rsvp_type']="";
                    $taskArrary['relatesto_commenttype_id']="";
                    $taskArrary['social_network_members']="";
                    $taskArrary['non_network_members']="";
                    $taskArrary['member_points_rangefrom']="";
                    $taskArrary['member_points_rangeto']="";
                }else{
                   // All contact related parameters should be null
                   $taskArrary['company_type']="";
                   $taskArrary['contact_type']="";
                   
                    if($taskArrary['member_agefrom']!="" && $taskArrary['member_agefrom']!="00-00-0000"){
                      ...
                      if($taskArrary['member_ageto']!="" &&  $taskArrary['member_ageto']!="00-00-0000"){
                     ...
                     if(!$taskArrary['member_anniversary_monthly']){
                         $taskArrary['member_anniversary_monthly']='0';
                     }
                     
                     if(!$taskArrary['member_anniversary_annual']){
                         $taskArrary['member_anniversary_annual']='0';
                     }
                }
                    ...
                    $taskArrary['task_startdate']=$sdt;
					               
                 if($taskArrary['task_end']=="by_date"){
                     $edata = explode("-", $taskArrary['task_end_by_date']);
                    $date = new DateTime();
                    $date->setDate($edata[2], $edata[0], $edata[1]);
                    $edt= $date->format("Y-m-d");
                    $taskArrary['task_end_by_date']=$edt;
