...
class CommunicationTaskExecutionReport extends AppModel{
 ...
 function getEmailsListByHolderCondition($holderid, $project_id, $email="", $searchkey=""){
     if($holderid && $project_id){
            $condition = "CommunicationTaskExecutionReport.project_id = '".$project_id."' AND CommunicationTaskExecutionReport.sent_to_holderid='".$holderid."' ";              
            if($email!=""){
