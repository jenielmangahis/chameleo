   ...
   function setEmailTempDataElementValuesForProjectHolder($projectId,$projectDetails, $toHolderEmailAddress, $userType="Holder"){           
        ...
        if($projectDetails!='' && $projectDetails!=null){  
            ...
            if(!empty($projectDetails['Project']['url'])) {
                             $pos = strpos($projectDetails['0']['Project']['url'],"http://");
                             if ($pos === false) {
                                 $project_home_url="http://".$projectDetails['0']['Project']['url'];
                             }else{
                                 $project_home_url=$projectDetails['0']['Project']['url']; 
                             }
                             ...
                             $project_home_url='http://'.HTTP_PATH.'/'.$projectDetails['0']['Project']['project_name'];
                        }
            $project_name=  $projectDetails['0']['Project']['system_name'];   
            if($projectDetails['0']['Project']['system_name']==""){
                $project_name=  ucfirst($projectDetails['0']['Project']['project_name']);   
            }
        ...
        //    $project_home_url_html= str_replace("http://", "",$project_home_url);
            ...
            $this->dataElementValuesArray[DATA_ELEMENT_PROJECT_OWNER_NAME]=$projectDetails['0']['Sponsor']['sponsor_name'];
            $this->dataElementValuesArray[DATA_ELEMENT_PROJECT_OWNER_EMAIL]=$projectDetails['0']['Sponsor']['email'];
            ...
            $statename="";
            if($projectDetails['0']['Sponsor']['state']){
                  $statename=AppController::getstatename($projectDetails['0']['Sponsor']['state']);       
            }
           
           $this->dataElementValuesArray[DATA_ELEMENT_PROJECT_ADDRESS1]=$projectDetails['0']['Sponsor']['address1'];    
           $this->dataElementValuesArray[DATA_ELEMENT_PROJECT_ADDRESS2]=$projectDetails['0']['Sponsor']['address2'];    
           $this->dataElementValuesArray[DATA_ELEMENT_PROJECT_CITY]=$projectDetails['0']['Sponsor']['city'];    
           $this->dataElementValuesArray[DATA_ELEMENT_PROJECT_STATE]=$statename;    
           $this->dataElementValuesArray[DATA_ELEMENT_PROJECT_ZIP]=$projectDetails['0']['Sponsor']['zipcode'];  
