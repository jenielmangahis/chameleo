       ...
       /* function getCompanyTypeDropdown($projectid='')
        ...
        function templatelist(){
        	...
        	if(!empty($this->data)){
        		...
        		$condition = "EmailTemplate.project_id IN (0,$project_id) AND EmailTemplate.email_template_name like '$varsearch' AND EmailTemplate.delete_status='0' AND EmailTemplate.active_status='1'  AND EmailTemplate.is_sytem ='1' AND EmailTemplate.is_event_temp='0' AND EmailTemplate.email_template_type ='1' " ;
        	}else{
        		$condition = "EmailTemplate.project_id IN(0,$project_id) AND EmailTemplate.delete_status='0' AND EmailTemplate.active_status='1' AND EmailTemplate.is_sytem ='1' AND EmailTemplate.is_event_temp='0' AND EmailTemplate.email_template_type = '1' ";
        	}
