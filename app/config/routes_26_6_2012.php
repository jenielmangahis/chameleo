...
//    if($current_domain == 'www.coins4promo.com' || $current_domain == 'coins4promo.com' )
    {
        ...
        $temp1 =$url_array[1];
        mysql_connect('localhost','gosocial_coincms','59JtNlM)R[Ot');
        mysql_select_db('gosocial_coincms');
        $rs = mysql_query("select project_name from projects where project_name='".$temp1."'");
